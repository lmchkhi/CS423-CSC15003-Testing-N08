...
| P02         | 22h24 25/07/2026 | "Quan sát một lúc, tự nhận ra tính toán của mã SAVE10 là sai và báo cáo cho facilitator"                                                  | Tổng tiền sau áp mã tăng thay vì giảm                | Hoàn thành có can thiệp (đã ghi nhận nhưng không được hướng dẫn xử lý) | Participant tự phát hiện độc lập bug đã log ở Task 1 (GUI-07/GUI-49 — coupon SAVE10 tính sai làm tăng giá) — đây là bằng chứng chéo, không phải finding mới | https://youtu.be/3PnK0Gon4dE |
