# TC-PRODUCT-UPDATE-031: Từ chối category_id null

## Requirement ID
FR-12, FR-15

## Module / Test type / Technique
PRODUCT-UPDATE / Functional / Null Testing
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"Sản phẩm kiểm thử 23127062","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":null}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-031`
