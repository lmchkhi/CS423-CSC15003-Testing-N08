# TC-PRODUCT-UPDATE-013: Chấp nhận tên Unicode tiếng Việt
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"Điện thoại kiểm thử 🧪","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-013`
