# TC-PRODUCT-UPDATE-021: Từ chối name kiểu object
...
| id | `1` |
| auth | `admin` |
| body | `{"name":{"value":"Sai kiểu"},"price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-021`
