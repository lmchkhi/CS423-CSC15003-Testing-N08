# TC-PRODUCT-UPDATE-033: Từ chối category_id bằng 0
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"Sản phẩm kiểm thử 23127062","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":0}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-033`
