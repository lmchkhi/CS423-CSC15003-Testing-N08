# TC-PRODUCT-UPDATE-030: Từ chối body thiếu category_id
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"Sản phẩm kiểm thử 23127062","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png"}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-030`
