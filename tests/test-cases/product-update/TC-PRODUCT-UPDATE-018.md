# TC-PRODUCT-UPDATE-018: Từ chối name rỗng
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-018`
