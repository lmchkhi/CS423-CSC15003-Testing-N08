# TC-PRODUCT-UPDATE-012: Chấp nhận tên một ký tự
...
| id | `1` |
| auth | `admin` |
| body | `{"name":"A","price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-012`
