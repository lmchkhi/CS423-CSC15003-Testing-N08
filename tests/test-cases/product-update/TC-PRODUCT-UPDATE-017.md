# TC-PRODUCT-UPDATE-017: Từ chối name null
...
| id | `1` |
| auth | `admin` |
| body | `{"name":null,"price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-017`
