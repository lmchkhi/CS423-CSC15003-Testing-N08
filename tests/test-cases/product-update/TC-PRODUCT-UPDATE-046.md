# TC-PRODUCT-UPDATE-046: Chống payload SQLi trong name mà không tác động sản phẩm khác

## Requirement ID
FR-15, SEC-05

## Module / Test type / Technique
PRODUCT-UPDATE / Security / Injection Testing
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-046`
