# TC-PRODUCT-UPDATE-020: Từ chối name kiểu array
...
| id | `1` |
| auth | `admin` |
| body | `{"name":["Sai kiểu"],"price":123456,"description":"Dữ liệu kiểm thử PUT product","imageUrl":"https://example.test/product.png","category_id":1}` |
...
## Automation mapping
- Data row: `TC-PRODUCT-UPDATE-020`
