# Áp dụng mã giảm giá theo lượng khi thoả tất cả yêu cầu hệ thống với giỏ hàng có nhiều hơn 1 sản phẩm thành công

## ID

TC-FR09-DISCOUNT-002

## Mô tả

Mã giảm giá được áp dụng thành công khi:

- mã giảm khi mã còn hạn, còn lượt, giảm giá lượng cố định
- Giỏ hàng có 2 sản phẩm có tổng lớn hơn giá trị tối thiểu cần thiết của mã giảm giá ***Lưu ý: Giá trị của từng sản phẩm nhỏ hơn lượng giảm của mã***
...
- Có một mã giảm mới được có tên `G7T` sao cho mã:
  - Giảm thẳng 7 triệu
  - Hợp lệ khi đơn giá từ 8 triệu trở lên
  - Có 1 lượt sử dụng
