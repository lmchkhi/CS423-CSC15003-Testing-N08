<!-- tests/test-cases/FR-09-coupon-mobile/domain-testing/TC-FR09-DT-005.md -->

# TC-FR09-DT-005: Chuỗi mã rỗng — không nhập gì (Domain Testing)
...
| ------ | ---------------------------------- | ------------------------- | ----------------- | ------------------------- | ------------------------- | --------------------------------- |
| DT-005 | **V1-04** (Empty: "" — chuỗi rỗng) | V2-01 (500,000₫ — hợp lệ) | V3-01 (Logged in) | V4-01 (N/A — không có mã) | V5-01 (N/A — không có mã) | ❌ Thông báo lỗi: yêu cầu nhập mã |
...
8. Không nhập bất kỳ ký tự nào — để ô nhập trống
9. Chạm nút "Áp dụng" bên cạnh ô nhập mã
10. Quan sát phản hồi từ hệ thống trên màn hình

## Expected result

- ❌ Hệ thống hiển thị Toast/Alert thông báo lỗi: "Vui lòng nhập mã giảm giá" hoặc "Mã giảm giá không được để trống"
- Nút "Áp dụng" có thể bị vô hiệu hóa (disabled) khi ô nhập trống, hoặc hiển thị thông báo validation
- Tổng thanh toán **không thay đổi**, vẫn giữ nguyên 500,000₫
- Không có mã giảm giá nào được áp dụng vào đơn hàng

## Actual result

- Nút "Áp dụng" có thể bị vô hiệu hóa (disabled) khi ô nhập trống
