# Cập nhật lại thông tin của sản phẩm chỉ với ảnh đại diện thay đổi
...
5. Điền vào mục **URL ảnh** giá trị [https://placehold.co/300x300/png?text=Vo+iPhone+15+Pro](https://placehold.co/300x300/png?text=Vo+iPhone+15+Pro)
6. Nhấn vào nút lưu sản phẩm.
7. Truy cập vào trang web người dùng với đường dẫn [http://localhost:5173/](http://localhost:5173/)
8. Nhấn vào **Xem chi tiết** của sản phẩm `Vỏ iPhone 15 Pro Max`
