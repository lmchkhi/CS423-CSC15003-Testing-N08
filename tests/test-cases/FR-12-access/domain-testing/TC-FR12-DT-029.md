<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-029.md -->

# TC-FR12-DT-029: Xóa sản phẩm — Không có Token (Domain Testing)
...
| ------ | --------- | ---- | ------------------------ | ------------------- |
| DT-029 | Không gửi | N/A  | DELETE `/api/products/1` | ❌ 401 Unauthorized |
...
2. Tạo request DELETE đến `http://localhost:3000/api/products/1`
...
Hệ thống trả về HTTP 200 OK. Response thông báo thành công, sản phẩm được xóa khỏi cơ sở dữ liệu. Không kiểm tra role, không kiểm tra sự tồn tại của Token.
