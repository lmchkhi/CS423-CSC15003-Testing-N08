<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-024.md -->

# TC-FR12-DT-024: Thêm sản phẩm — Token user thường (Domain Testing)
...
| ------ | ----------------------- | ---- | -------------------- | ---------------- |
| DT-024 | Hợp lệ (test@eshop.com) | user | POST `/api/products` | ❌ 403 Forbidden |
