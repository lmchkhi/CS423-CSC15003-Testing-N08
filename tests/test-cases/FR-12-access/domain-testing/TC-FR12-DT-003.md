<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-003.md -->

# TC-FR12-DT-003: Truy cập API danh sách người dùng — Token user thường (Domain Testing)
...
| ------ | ---------------------- | ---- | ---------------------- | --------------------------------- |
| DT-003 | Valid (test@eshop.com) | user | GET `/api/admin/users` | ❌ 403 Forbidden — không đủ quyền |
...
Hệ thống trả về HTTP 200 OK. Response body chứa danh sách người dùng. Không có kiểm tra role, chỉ cần Token hợp lệ là được truy cập tài nguyên.
