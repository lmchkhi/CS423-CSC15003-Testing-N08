<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-026.md -->

# TC-FR12-DT-026: Cập nhật sản phẩm — Không có Token (Domain Testing)
...
| ------ | --------- | ---- | --------------------- | ------------------- |
| DT-026 | Không gửi | N/A  | PUT `/api/products/1` | ❌ 401 Unauthorized |
...
2. Tạo request PUT đến `http://localhost:3000/api/products/1`
3. KHÔNG thêm header `Authorization`
4. Thêm body JSON: `{"name": "SP Updated", "price": 60000, "description": "Mô tả updated", "imageUrl": "", "category_id": 1}`
5. Gửi request
...
Hệ thống trả về HTTP 200 OK. Response thông báo thành công, sản phẩm được cập nhật trong cơ sở dữ liệu. Không kiểm tra role, Không kiểm tra sự tồn tại của Token.
