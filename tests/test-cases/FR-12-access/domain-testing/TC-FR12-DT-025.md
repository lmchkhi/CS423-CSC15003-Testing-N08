<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-025.md -->

# TC-FR12-DT-025: Thêm sản phẩm — Token admin (Domain Testing)
...
| ------ | ------------------------ | ----- | -------------------- | --------- |
| DT-025 | Hợp lệ (admin@eshop.com) | admin | POST `/api/products` | ✅ 200 OK |
...
3. Tạo request POST đến `http://localhost:3000/api/products`
4. Thêm header `Authorization: Bearer <admin_token>`
5. Thêm body JSON: `{"name": "SP Test AC", "price": 50000, "description": "Mô tả test", "imageUrl": "", "category_id": 1}`
6. Gửi request
7. Kiểm tra HTTP response status code và response body

## Expected result

Hệ thống trả về HTTP 200 OK. Sản phẩm mới được tạo thành công. Response body chứa thông tin sản phẩm vừa tạo.
