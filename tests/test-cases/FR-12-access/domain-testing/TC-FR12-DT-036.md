<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-036.md -->

# TC-FR12-DT-036: Cập nhật danh mục — Token user thường (Domain Testing)
...
| ------ | ---------------------- | ---- | ----------------------- | ---------------- |
| DT-036 | Valid (test@eshop.com) | user | PUT `/api/categories/1` | ❌ 403 Forbidden |
...
Hệ thống trả về HTTP 200 OK. Response thông báo thành công, danh mục được cập nhật trong cơ sở dữ liệu. Không kiểm tra role, chỉ kiểm tra sự tồn tại của Token.
