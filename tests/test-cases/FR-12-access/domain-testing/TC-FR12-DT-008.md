<!-- tests/test-cases/FR-12-access/domain-testing/TC-FR12-DT-008.md -->

# TC-FR12-DT-008: Truy cập API danh sách đơn hàng (Admin) — Không có Token (Domain Testing)
...
| ------ | --------- | ---- | ----------------------- | -------------------------------------- |
| DT-008 | Không gửi | N/A  | GET `/api/admin/orders` | ❌ 401 Unauthorized — yêu cầu xác thực |
...
2. Tạo request GET đến `http://localhost:3000/api/admin/orders`
