# TC-FR08-005: total_amount bằng 0
...
|---|---|---|---|---|
| TC-FR08-005 | 0 / "123 Le Loi, Q1" / user | User token hợp lệ | 400 Bad Request (phải từ chối) | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | 0 / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount bằng 0 |
