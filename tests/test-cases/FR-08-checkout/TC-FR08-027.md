# TC-FR08-027: Trạng thái - pending sang shipping không hợp lệ
...
|---|---|---|---|---|
| TC-FR08-027 | Admin cập nhật orderId sang status "shipping" | Đơn hàng đang ở trạng thái pending | 400 Bad Request (must confirm first) | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | Admin cập nhật orderId sang status "shipping" |
| Nhóm kiểm thử | Trạng thái - pending sang shipping không hợp lệ |
...
## Kết quả mong đợi
400 Bad Request (must confirm first)
