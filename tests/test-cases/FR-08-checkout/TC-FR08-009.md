# TC-FR08-009: total_amount kiểu float
...
|---|---|---|---|---|
| TC-FR08-009 | 199.99 / "123 Le Loi, Q1" / user | User token hợp lệ | 200 OK (được chấp nhận) hoặc 400 | Kiểm tra float handled correctly |
...
| Dữ liệu / Hành động | 199.99 / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount kiểu float |
...
## Kết quả mong đợi
200 OK (được chấp nhận) hoặc 400

Oracle: Kiểm tra float handled correctly
