# TC-FR08-020: Schema - Có field thừa
...
|---|---|---|---|---|
| TC-FR08-020 | 200000 / "123 Le Loi" / user + {"extra":"field"} | User token hợp lệ | 200 OK (ignore extra) hoặc 400 | Kiểm tra schema nghiêm ngặt |
...
| Dữ liệu / Hành động | 200000 / "123 Le Loi" / user + {"extra":"field"} |
| Nhóm kiểm thử | Schema - Có field thừa |
...
## Kết quả mong đợi
200 OK (ignore extra) hoặc 400

Oracle: Kiểm tra schema nghiêm ngặt
