# TC-FR08-010: Thiếu total_amount
...
|---|---|---|---|---|
| TC-FR08-010 | (omitted) / "123 Le Loi, Q1" / user | User token hợp lệ | 400 Bad Request | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | (omitted) / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | Thiếu total_amount |
