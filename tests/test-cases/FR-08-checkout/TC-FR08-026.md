# TC-FR08-026: Trạng thái - pending sang delivered không hợp lệ
...
|---|---|---|---|---|
| TC-FR08-026 | Admin cập nhật orderId sang status "delivered" | Đơn hàng đang ở trạng thái pending | 400 Bad Request (illegal jump) | Mã phản hồi 400 |
...
| Nhóm kiểm thử | Trạng thái - pending sang delivered không hợp lệ |
