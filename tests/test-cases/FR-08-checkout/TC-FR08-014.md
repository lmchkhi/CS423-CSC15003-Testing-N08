# TC-FR08-014: shipping_address rỗng
...
|---|---|---|---|---|
| TC-FR08-014 | 200000 / "" / user | User token hợp lệ | 400 Bad Request (phải từ chối) | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | 200000 / "" / user |
| Nhóm kiểm thử | shipping_address rỗng |
