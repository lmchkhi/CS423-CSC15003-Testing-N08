# TC-FR08-004: Xác thực - User token hợp lệ
...
|---|---|---|---|---|
| TC-FR08-004 | 150000 / "456 Nguyen Hue, Q3" / user | User token hợp lệ | 200 OK | Mã phản hồi 200; orderId returned |
...
| Dữ liệu / Hành động | 150000 / "456 Nguyen Hue, Q3" / user |
| Nhóm kiểm thử | Xác thực - User token hợp lệ |
...
Oracle: Mã phản hồi 200; orderId returned
