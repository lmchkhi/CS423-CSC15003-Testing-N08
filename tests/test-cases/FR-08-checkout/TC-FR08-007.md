# TC-FR08-007: total_amount dương nhỏ
...
|---|---|---|---|---|
| TC-FR08-007 | 1 / "123 Le Loi, Q1" / user | User token hợp lệ | 200 OK (boundary) | Mã phản hồi 200 |
...
| Dữ liệu / Hành động | 1 / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount dương nhỏ |
