# TC-FR08-034: Biên - total_amount = 1
...
|---|---|---|---|---|
| TC-FR08-034 | 1 / "123 Le Loi" / user | User token hợp lệ | 200 OK | Mã phản hồi 200 |
...
| Dữ liệu / Hành động | 1 / "123 Le Loi" / user |
| Nhóm kiểm thử | Biên - total_amount = 1 |
