# TC-FR08-021: Nghiệp vụ - Kiểm tra giỏ hàng
...
|---|---|---|---|---|
| TC-FR08-021 | 50000 / "123 Le Loi" / user | Cart total is 200000 (mismatch) | 400 Bad Request (should validate) | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | 50000 / "123 Le Loi" / user |
| Nhóm kiểm thử | Nghiệp vụ - Kiểm tra giỏ hàng |
...
## Kết quả mong đợi
400 Bad Request (should validate)
