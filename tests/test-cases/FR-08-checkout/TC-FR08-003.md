# TC-FR08-003: Xác thực - Token không hợp lệ
...
|---|---|---|---|---|
| TC-FR08-003 | 200000 / "123 Le Loi, Q1" / không hợp lệ | Token sai định dạng "Bearer not.a.real.token" | 403 Forbidden | Mã phản hồi 403 |
...
| Dữ liệu / Hành động | 200000 / "123 Le Loi, Q1" / không hợp lệ |
| Nhóm kiểm thử | Xác thực - Token không hợp lệ |
