...
|---|---|---|---|---|
| TC-FR08-001 | 200000 / "123 Le Loi, Q1, TP.HCM" / user | User token hợp lệ | 200 OK; `{message:"Checkout successful", orderId:<int>}` | Mã phản hồi 200; khớp schema; orderId là integer |
...
| Dữ liệu / Hành động | 200000 / "123 Le Loi, Q1, TP.HCM" / user |
| Nhóm kiểm thử | Thanh toán hợp lệ |
...
## Kết quả mong đợi
200 OK; `{message:"Checkout successful", orderId:<int>}`

Oracle: Mã phản hồi 200; khớp schema; orderId là integer
