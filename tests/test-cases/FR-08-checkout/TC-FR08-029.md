# TC-FR08-029: Trạng thái - canceled sang delivered không hợp lệ
...
|---|---|---|---|---|
| TC-FR08-029 | Admin cập nhật orderId sang status "delivered" | Đơn hàng đang ở trạng thái canceled | 400 Bad Request (canceled is terminal) | Mã phản hồi 400 |
...
| Nhóm kiểm thử | Trạng thái - canceled sang delivered không hợp lệ |
...
## Kết quả mong đợi
400 Bad Request (canceled is terminal)
