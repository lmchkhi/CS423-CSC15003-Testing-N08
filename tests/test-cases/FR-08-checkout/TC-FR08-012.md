# TC-FR08-012: total_amount là chuỗi rỗng
...
|---|---|---|---|---|
| TC-FR08-012 | "" / "123 Le Loi, Q1" / user | User token hợp lệ | 400 Bad Request | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | "" / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount là chuỗi rỗng |
