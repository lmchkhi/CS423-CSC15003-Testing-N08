# TC-FR08-028: Trạng thái - pending sang canceled hợp lệ
...
|---|---|---|---|---|
| TC-FR08-028 | Admin cập nhật orderId sang status "canceled" | Đơn hàng đang ở trạng thái pending | 200 OK | Mã phản hồi 200 |
...
| Dữ liệu / Hành động | Admin cập nhật orderId sang status "canceled" |
| Nhóm kiểm thử | Trạng thái - pending sang canceled hợp lệ |
