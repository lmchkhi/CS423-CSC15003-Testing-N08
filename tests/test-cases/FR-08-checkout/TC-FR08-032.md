# TC-FR08-032: SQL injection trong shipping_address
...
|---|---|---|---|---|
| TC-FR08-032 | 200000 / "123' OR '1'='1" / user | User token hợp lệ | 200 OK (parameterized) hoặc 400 | Kiểm tra được lưu an toàn |
...
| Dữ liệu / Hành động | 200000 / "123' OR '1'='1" / user |
| Nhóm kiểm thử | SQL injection trong shipping_address |
...
## Kết quả mong đợi
200 OK (parameterized) hoặc 400

Oracle: Kiểm tra được lưu an toàn
