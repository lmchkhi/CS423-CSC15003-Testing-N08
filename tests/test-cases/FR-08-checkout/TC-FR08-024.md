# TC-FR08-024: Trạng thái - confirmed sang shipping
...
|---|---|---|---|---|
| TC-FR08-024 | Admin cập nhật orderId sang status "shipping" | Đơn hàng đang ở trạng thái confirmed | 200 OK; status updated | PUT /api/admin/orders/:id/status returns 200 |
...
| Nhóm kiểm thử | Trạng thái - confirmed sang shipping |
