...
|---|---|---|---|---|
| TC-FR08-006 | -5000 / "123 Le Loi, Q1" / user | User token hợp lệ | 400 Bad Request (phải từ chối) | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | -5000 / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount âm |
