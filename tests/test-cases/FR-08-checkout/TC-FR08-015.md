# TC-FR08-015: Thiếu shipping_address
...
|---|---|---|---|---|
| TC-FR08-015 | 200000 / (omitted) / user | User token hợp lệ | 400 Bad Request | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | 200000 / (omitted) / user |
| Nhóm kiểm thử | Thiếu shipping_address |
