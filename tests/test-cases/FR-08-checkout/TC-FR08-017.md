# TC-FR08-017: shipping_address có Unicode
...
|---|---|---|---|---|
| TC-FR08-017 | 200000 / "123 Lê Lợi, Quận 1, Thành phố Hồ Chí Minh" / user | User token hợp lệ | 200 OK (unicode supported) | Mã phản hồi 200 |
...
| Dữ liệu / Hành động | 200000 / "123 Lê Lợi, Quận 1, Thành phố Hồ Chí Minh" / user |
| Nhóm kiểm thử | shipping_address có Unicode |
