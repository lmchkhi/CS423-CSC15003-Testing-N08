# TC-FR08-011: total_amount là chuỗi không phải số
...
|---|---|---|---|---|
| TC-FR08-011 | "abc" / "123 Le Loi, Q1" / user | User token hợp lệ | 400 Bad Request | Mã phản hồi 400 |
...
| Dữ liệu / Hành động | "abc" / "123 Le Loi, Q1" / user |
| Nhóm kiểm thử | total_amount là chuỗi không phải số |
