# TC-FR08-023: Trạng thái - pending sang confirmed
...
|---|---|---|---|---|
| TC-FR08-023 | Admin cập nhật orderId sang status "confirmed" | Đơn hàng đang ở trạng thái pending | 200 OK; status updated | PUT /api/admin/orders/:id/status returns 200 |
...
| Dữ liệu / Hành động | Admin cập nhật orderId sang status "confirmed" |
| Nhóm kiểm thử | Trạng thái - pending sang confirmed |
