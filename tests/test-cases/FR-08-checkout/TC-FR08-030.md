# TC-FR08-030: Bảo mật - IDOR đọc đơn hàng
...
|---|---|---|---|---|
| TC-FR08-030 | GET /api/orders/:id với no token | Đơn hàng tồn tại | 401 Unauthorized (phải yêu cầu xác thực) | Mã phản hồi 401 |
...
| Dữ liệu / Hành động | GET /api/orders/:id với no token |
| Nhóm kiểm thử | Bảo mật - IDOR đọc đơn hàng |
...
## Kết quả mong đợi
401 Unauthorized (phải yêu cầu xác thực)

Oracle: Mã phản hồi 401
