# TC-FR08-018: shipping_address chỉ gồm khoảng trắng
...
|---|---|---|---|---|
| TC-FR08-018 | 200000 / "   " / user | User token hợp lệ | 400 Bad Request | Mã phản hồi 400 |
...
| Nhóm kiểm thử | shipping_address chỉ gồm khoảng trắng |
