# TC-FR08-035: Biên - total_amount = MAX_INT
...
|---|---|---|---|---|
| TC-FR08-035 | 2147483647 / "123 Le Loi" / user | User token hợp lệ | 200 OK | Mã phản hồi 200 |
...
| Dữ liệu / Hành động | 2147483647 / "123 Le Loi" / user |
| Nhóm kiểm thử | Biên - total_amount = MAX_INT |
