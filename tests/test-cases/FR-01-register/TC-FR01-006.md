...
|---|---|---|---|---|
| TC-FR01-006 | "Nguyễn Văn Á" / "email@hw06.test" / "Password123!" | Tài khoản mới | 200 OK (nếu được hỗ trợ) hoặc 400 | Chấp nhận hoặc từ chối unicode consistently |
...
| Dữ liệu | "Nguyễn Văn Á" / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Tên có Unicode |
...
## Kết quả mong đợi
200 OK (nếu được hỗ trợ) hoặc 400

Oracle: Chấp nhận hoặc từ chối unicode consistently
