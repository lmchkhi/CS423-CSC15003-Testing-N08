# TC-EX-004: Mật khẩu yếu được chấp nhận (không kiểm tra độ phức tạp)
...
|---|---|---|---|---|
| TC-EX-004 | Đăng ký David với mật khẩu `123`. | Email mới và chưa được đăng ký trước đó. | Phải từ chối mật khẩu yếu với 400. | Nếu SUT trả 200, hệ thống không enforce độ phức tạp mật khẩu. |
...
## Kết quả mong đợi
Phải từ chối mật khẩu yếu với 400.

Oracle: Nếu SUT trả 200, hệ thống không enforce độ phức tạp mật khẩu.
