# TC-FR01-030: Mật khẩu thiếu ký tự đặc biệt
...
|---|---|---|---|---|
| TC-FR01-030 | "Test User" / "email@hw06.test" / "Password123" | Tài khoản mới | 400 Bad Request; complexity | Mã phản hồi 400 hoặc 200 |
...
| Nhóm kiểm thử | Mật khẩu thiếu ký tự đặc biệt |
...
Oracle: Mã phản hồi 400 hoặc 200
