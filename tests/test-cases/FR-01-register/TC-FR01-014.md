...
|---|---|---|---|---|
| TC-FR01-014 | "Test User" / "user@domain" / "Password123!" | Tài khoản mới | 400 Bad Request hoặc 200 (tùy validation) | Kiểm tra email format strictness |
...
| Dữ liệu | "Test User" / "user@domain" / "Password123!" |
| Nhóm kiểm thử | Email thiếu TLD |
...
## Kết quả mong đợi
400 Bad Request hoặc 200 (tùy validation)

Oracle: Kiểm tra email format strictness
