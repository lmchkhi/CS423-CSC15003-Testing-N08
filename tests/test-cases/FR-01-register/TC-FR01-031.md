# TC-FR01-031: Mật khẩu chỉ gồm khoảng trắng
...
|---|---|---|---|---|
| TC-FR01-031 | "Test User" / "email@hw06.test" / "        " | Tài khoản mới | 400 Bad Request; whitespace | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "        " |
| Nhóm kiểm thử | Mật khẩu chỉ gồm khoảng trắng |
