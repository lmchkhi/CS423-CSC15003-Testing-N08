# TC-FR01-034: Schema - Có field thừa
...
|---|---|---|---|---|
| TC-FR01-034 | "Test" / "email@hw06.test" / "Password123!" + {"extra":"field"} | Tài khoản mới | 200 OK (ignore extra) hoặc 400 | Kiểm tra schema nghiêm ngặt |
...
| Dữ liệu | "Test" / "email@hw06.test" / "Password123!" + {"extra":"field"} |
