# TC-FR01-016: Email có khoảng trắng cuối chuỗi
...
|---|---|---|---|---|
| TC-FR01-016 | "Test User" / "user@hw06.test " / "Password123!" | Tài khoản mới | 400 Bad Request hoặc được trim | Kiểm tra trim behavihoặc |
...
| Dữ liệu | "Test User" / "user@hw06.test " / "Password123!" |
| Nhóm kiểm thử | Email có khoảng trắng cuối chuỗi |
...
## Kết quả mong đợi
400 Bad Request hoặc được trim

Oracle: Kiểm tra trim behavihoặc
