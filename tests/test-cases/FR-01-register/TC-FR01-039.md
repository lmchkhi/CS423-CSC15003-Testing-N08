# TC-FR01-039: Bảo mật - SQL injection trong name
...
|---|---|---|---|---|
| TC-FR01-039 | "'; DROP TABLE users; --" / "email@hw06.test" / "Password123!" | Tài khoản mới | 400 Bad Request; không bị injection | Xác minh bảng vẫn tồn tại sau test |
...
| Dữ liệu | "'; DROP TABLE users; --" / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Bảo mật - SQL injection trong name |
...
## Kết quả mong đợi
400 Bad Request; không bị injection

Oracle: Xác minh bảng vẫn tồn tại sau test
