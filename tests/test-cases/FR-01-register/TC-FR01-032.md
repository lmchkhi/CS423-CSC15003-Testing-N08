# TC-FR01-032: Mật khẩu quá dài (500 ký tự)
...
|---|---|---|---|---|
| TC-FR01-032 | "Test User" / "email@hw06.test" / "Pass" * 125 | Tài khoản mới | 400 Bad Request; giới hạn độ dài | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "Pass" * 125 |
| Nhóm kiểm thử | Mật khẩu quá dài (500 ký tự) |
