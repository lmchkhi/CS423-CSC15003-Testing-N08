# TC-FR01-027: Mật khẩu quá ngắn (7 ký tự)
...
|---|---|---|---|---|
| TC-FR01-027 | "Test User" / "email@hw06.test" / "Pass12!" | Tài khoản mới | 400 Bad Request; min length 8 | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "Pass12!" |
| Nhóm kiểm thử | Mật khẩu quá ngắn (7 ký tự) |
