...
|---|---|---|---|---|
| TC-FR01-010 | "Test User" / "" / "Password123!" | Tài khoản mới | 400 Bad Request; validation | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "" / "Password123!" |
| Nhóm kiểm thử | Email rỗng |
