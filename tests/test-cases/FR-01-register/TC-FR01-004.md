# TC-FR01-004: Tên chỉ gồm khoảng trắng
...
|---|---|---|---|---|
| TC-FR01-004 | "   " / "email@hw06.test" / "Password123!" | Tài khoản mới | 400 Bad Request; whitespace rejection | Mã phản hồi 400 |
...
| Dữ liệu | "   " / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Tên chỉ gồm khoảng trắng |
...
## Kết quả mong đợi
400 Bad Request; whitespace rejection
