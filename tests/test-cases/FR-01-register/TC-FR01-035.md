# TC-FR01-035: Trạng thái - Tài khoản mới
...
|---|---|---|---|---|
| TC-FR01-035 | "Alice" / "alice@hw06.test" / "Password123!" | Chưa có tài khoản trước đó | 200 OK; id được sinh | Mã phản hồi 200; id là integer |
...
| Dữ liệu | "Alice" / "alice@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Trạng thái - Tài khoản mới |
...
Oracle: Mã phản hồi 200; id là integer
