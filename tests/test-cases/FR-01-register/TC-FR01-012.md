...
|---|---|---|---|---|
| TC-FR01-012 | "Test User" / "không hợp lệemail.com" / "Password123!" | Tài khoản mới | 400 Bad Request; email format | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "không hợp lệemail.com" / "Password123!" |
| Nhóm kiểm thử | Email thiếu ký tự @ |
