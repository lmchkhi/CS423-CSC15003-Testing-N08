# TC-FR01-028: Mật khẩu thiếu chữ hoa
...
|---|---|---|---|---|
| TC-FR01-028 | "Test User" / "email@hw06.test" / "password123!" | Tài khoản mới | 400 Bad Request; complexity | Mã phản hồi 400 hoặc 200 (check spec) |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "password123!" |
| Nhóm kiểm thử | Mật khẩu thiếu chữ hoa |
...
## Kết quả mong đợi
400 Bad Request; complexity

Oracle: Mã phản hồi 400 hoặc 200 (check spec)
