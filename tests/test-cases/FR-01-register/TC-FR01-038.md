# TC-FR01-038: Bảo mật - Đăng ký hàng loạt
...
|---|---|---|---|---|
| TC-FR01-038 | Same email base, +1/+2 variations × 100 rapid | Không có xác thực/rate limit | 200 OK but flood server | Observe if rate-limit applied |
...
| Dữ liệu | Same email base, +1/+2 variations × 100 rapid |
| Nhóm kiểm thử | Bảo mật - Đăng ký hàng loạt |
...
## Kết quả mong đợi
200 OK but flood server

Oracle: Observe if rate-limit applied
