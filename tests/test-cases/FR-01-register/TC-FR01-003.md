...
|---|---|---|---|---|
| TC-FR01-003 | (omitted) / "email@hw06.test" / "Password123!" | Tài khoản mới | 400 Bad Request; lỗi validation | Mã phản hồi 400 |
...
| Dữ liệu | (omitted) / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Thiếu trường tên |
