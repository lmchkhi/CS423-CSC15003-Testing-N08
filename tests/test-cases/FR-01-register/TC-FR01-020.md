# TC-FR01-020: Email chứa XSS event
...
|---|---|---|---|---|
| TC-FR01-020 | "Test User" / "test@hw06.test' onclick='alert(1)'" / "Password123!" | Tài khoản mới | 400 Bad Request; XSS protection | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "test@hw06.test' onclick='alert(1)'" / "Password123!" |
| Nhóm kiểm thử | Email chứa XSS event |
