# TC-FR01-037: Bảo mật - Lộ mật khẩu plaintext
...
|---|---|---|---|---|
| TC-FR01-037 | "Charlie" / "charlie@hw06.test" / "SecurePass123!" | Sau khi đăng ký qua /login | Password không được xuất hiện trong /api/users/me | Kiểm tra /users/me response |
...
| Dữ liệu | "Charlie" / "charlie@hw06.test" / "SecurePass123!" |
| Nhóm kiểm thử | Bảo mật - Lộ mật khẩu plaintext |
...
## Kết quả mong đợi
Password không được xuất hiện trong /api/users/me

Oracle: Kiểm tra /users/me response
