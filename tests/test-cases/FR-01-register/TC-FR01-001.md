...
|---|---|---|---|---|
| TC-FR01-001 | "Nguyen Van A" / "valid@hw06.test" / "Password123!" | Tài khoản mới | 200 OK; `{message:"User registered successfully", id:<int>}` | Mã phản hồi 200; khớp schema |
...
| Dữ liệu | "Nguyen Van A" / "valid@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Đăng ký hợp lệ |
...
## Kết quả mong đợi
200 OK; `{message:"User registered successfully", id:<int>}`

Oracle: Mã phản hồi 200; khớp schema
