# TC-FR01-013: Email thiếu domain
...
|---|---|---|---|---|
| TC-FR01-013 | "Test User" / "user@" / "Password123!" | Tài khoản mới | 400 Bad Request; incomplete email | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "user@" / "Password123!" |
| Nhóm kiểm thử | Email thiếu domain |
...
## Kết quả mong đợi
400 Bad Request; incomplete email
