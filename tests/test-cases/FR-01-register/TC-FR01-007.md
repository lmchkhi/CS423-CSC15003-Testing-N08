# TC-FR01-007: Tên chỉ gồm chữ số
...
|---|---|---|---|---|
| TC-FR01-007 | "12345" / "email@hw06.test" / "Password123!" | Tài khoản mới | 200 OK (numeric allowed?) hoặc 400 | Chấp nhận hoặc từ chối per spec |
...
| Dữ liệu | "12345" / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Tên chỉ gồm chữ số |
...
## Kết quả mong đợi
200 OK (numeric allowed?) hoặc 400

Oracle: Chấp nhận hoặc từ chối per spec
