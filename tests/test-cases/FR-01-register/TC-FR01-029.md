# TC-FR01-029: Mật khẩu thiếu chữ số
...
|---|---|---|---|---|
| TC-FR01-029 | "Test User" / "email@hw06.test" / "Password!" | Tài khoản mới | 400 Bad Request; complexity | Mã phản hồi 400 hoặc 200 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "Password!" |
| Nhóm kiểm thử | Mật khẩu thiếu chữ số |
