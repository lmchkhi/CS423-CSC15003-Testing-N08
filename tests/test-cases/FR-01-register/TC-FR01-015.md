# TC-FR01-015: Email có khoảng trắng đầu chuỗi
...
|---|---|---|---|---|
| TC-FR01-015 | "Test User" / " user@hw06.test" / "Password123!" | Tài khoản mới | 400 Bad Request; whitespace | Mã phản hồi 400 |
...
| Nhóm kiểm thử | Email có khoảng trắng đầu chuỗi |
