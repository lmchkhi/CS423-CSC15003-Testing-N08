# TC-FR01-026: Mật khẩu quá ngắn (3 ký tự)
...
|---|---|---|---|---|
| TC-FR01-026 | "Test User" / "email@hw06.test" / "abc" | Tài khoản mới | 400 Bad Request; min length 8 | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "abc" |
| Nhóm kiểm thử | Mật khẩu quá ngắn (3 ký tự) |
