...
|---|---|---|---|---|
| TC-FR01-005 | "A" * 300 / "email@hw06.test" / "Password123!" | Tài khoản mới | 400 Bad Request; giới hạn độ dài | Mã phản hồi 400 |
...
| Dữ liệu | "A" * 300 / "email@hw06.test" / "Password123!" |
| Nhóm kiểm thử | Tên quá dài |
