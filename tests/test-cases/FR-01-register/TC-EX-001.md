# TC-EX-001: Email trùng được chấp nhận (thiếu ràng buộc unique)
...
|---|---|---|---|---|
| TC-EX-001 | Đăng ký Bob với email đã được Alice sử dụng. | Alice đã được đăng ký với `alice@hw06.test`. | Phải từ chối email trùng với 400 hoặc 409. | Hành vi quan sát được: SUT trả 200 và chèn dòng thứ hai; đánh dấu bug đã biết. |
...
## Kết quả mong đợi
Phải từ chối email trùng với 400 hoặc 409.

Oracle: Hành vi quan sát được: SUT trả 200 và chèn dòng thứ hai; đánh dấu bug đã biết.
