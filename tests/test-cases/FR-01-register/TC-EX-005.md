# TC-EX-005: Email chỉ gồm khoảng trắng được chấp nhận
...
|---|---|---|---|---|
| TC-EX-005 | Đăng ký Eve với email chỉ gồm khoảng trắng. | Giá trị email gồm bốn khoảng trắng. | Phải từ chối email không hợp lệ/rỗng với 400. | Nếu SUT trả 200, validation định dạng email đang bị thiếu. |
...
## Kết quả mong đợi
Phải từ chối email không hợp lệ/rỗng với 400.

Oracle: Nếu SUT trả 200, validation định dạng email đang bị thiếu.
