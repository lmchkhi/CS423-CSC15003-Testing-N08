# TC-FR01-040: Bảo mật - SQL injection trong password
...
|---|---|---|---|---|
| TC-FR01-040 | "Test User" / "email@hw06.test" / "Pass' OR '1'='1" | Tài khoản mới | 400 Bad Request hoặc 200 (parameterized) | Kiểm tra stored safely |
...
| Dữ liệu | "Test User" / "email@hw06.test" / "Pass' OR '1'='1" |
| Nhóm kiểm thử | Bảo mật - SQL injection trong password |
...
## Kết quả mong đợi
400 Bad Request hoặc 200 (parameterized)

Oracle: Kiểm tra stored safely
