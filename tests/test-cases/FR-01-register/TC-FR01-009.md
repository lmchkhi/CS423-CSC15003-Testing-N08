...
|---|---|---|---|---|
| TC-FR01-009 | "Test User" / "valid.email@domain.com" / "Password123!" | Tài khoản mới | 200 OK | Mã phản hồi 200 |
...
| Dữ liệu | "Test User" / "valid.email@domain.com" / "Password123!" |
| Nhóm kiểm thử | Email hợp lệ |
