# TC-FR01-019: Email chứa XSS script tag
...
|---|---|---|---|---|
| TC-FR01-019 | "Test User" / "<script>alert('xss')</script>" / "Password123!" | Tài khoản mới | 400 Bad Request; XSS protection | Mã phản hồi 400; no XSS |
...
| Dữ liệu | "Test User" / "<script>alert('xss')</script>" / "Password123!" |
| Nhóm kiểm thử | Email chứa XSS script tag |
...
## Kết quả mong đợi
400 Bad Request; XSS protection

Oracle: Mã phản hồi 400; no XSS
