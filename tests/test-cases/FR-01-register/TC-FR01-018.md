# TC-FR01-018: Email chứa SQL meta UNION
...
|---|---|---|---|---|
| TC-FR01-018 | "Test User" / "a' UNION SELECT" / "Password123!" | Tài khoản mới | 400 Bad Request; SQL injection protection | Mã phản hồi 400; không bị injection |
...
| Dữ liệu | "Test User" / "a' UNION SELECT" / "Password123!" |
| Nhóm kiểm thử | Email chứa SQL meta UNION |
...
## Kết quả mong đợi
400 Bad Request; SQL injection protection

Oracle: Mã phản hồi 400; không bị injection
