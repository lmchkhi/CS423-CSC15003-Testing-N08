# TC-FR01-025: Thiếu trường mật khẩu
...
|---|---|---|---|---|
| TC-FR01-025 | "Test User" / "email@hw06.test" / (omitted) | Tài khoản mới | 400 Bad Request; validation | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "email@hw06.test" / (omitted) |
| Nhóm kiểm thử | Thiếu trường mật khẩu |
