# TC-FR01-017: Email chứa SQL meta OR
...
|---|---|---|---|---|
| TC-FR01-017 | "Test User" / "a' OR '1'='1" / "Password123!" | Tài khoản mới | 400 Bad Request; SQL injection protection | Mã phản hồi 400; không bị injection |
...
| Dữ liệu | "Test User" / "a' OR '1'='1" / "Password123!" |
| Nhóm kiểm thử | Email chứa SQL meta OR |
