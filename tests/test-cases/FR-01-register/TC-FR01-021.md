# TC-FR01-021: Email dài 320 ký tự
...
|---|---|---|---|---|
| TC-FR01-021 | "Test User" / "a" * 300 + "@test.com" / "Password123!" | Tài khoản mới | 400 Bad Request; giới hạn độ dài | Mã phản hồi 400 |
...
| Dữ liệu | "Test User" / "a" * 300 + "@test.com" / "Password123!" |
| Nhóm kiểm thử | Email dài 320 ký tự |
