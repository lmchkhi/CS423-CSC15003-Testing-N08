# TC-FR26-DT-004: Giảm số lượng sản phẩm bằng nút -
...
|---|---|---|---|
| COND-FR26-DT-004 | Giỏ có Áo thun Basic số lượng 2 | EC-QUANTITY-V02: bấm nút - | Số lượng giảm xuống 1; thành tiền và "Tổng cộng" cập nhật theo số lượng mới. |

## Preconditions
- Ứng dụng Mobile đã mở được màn Giỏ hàng.
- Giỏ hàng có đúng 1 dòng Áo thun Basic, đơn giá 120000, số lượng 2.
...
| Thành tiền sau khi bấm - | 120000 |
| Tổng cộng sau khi bấm - | 120000 |
...
## Expected result
Số lượng Áo thun Basic giảm từ 2 xuống 1. Thành tiền của dòng Áo thun Basic cập nhật thành 120000. Khu vực tổng tiền vẫn hiển thị nhãn "Tổng cộng" và giá trị tổng cộng cập nhật thành 120000.
