<!-- tests/test-cases/FR-09-coupon/state-transition/TC-FR09-STT-009.md -->

# TC-FR09-STT-009: Place order with coupon (State Transition Testing)
...
| --------------- | ----------- | --------------- | ------------------ | --------------- | -------------------------------------- |
| TC-FR09-STT-009 | S2: Applied | E3: Place Order | —                  | S4: Checked Out | ✅ Đặt hàng thành công với giá đã giảm |
...
> Tiến hành checkout với discount

## Test steps

1. Ở trạng thái S2 (Applied)
2. Bấm nút 'Đặt hàng' / 'Thanh toán' (E3)
3. Đợi server xử lý đặt hàng

## Expected result

Hệ thống chuyển sang S4: Checked Out. Tạo đơn hàng thành công với final_amount đã trừ discount. Giỏ hàng bị xóa. Chuyển sang trang cảm ơn/đơn hàng thành công.

## Actual result

Với dữ liệu hiện tại SAVE10 không vào được trạng thái Applied
