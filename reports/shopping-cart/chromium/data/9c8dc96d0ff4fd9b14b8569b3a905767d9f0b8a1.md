...
- Name: shopping-cart.spec.mjs >> FR-07 - Giỏ hàng >> TC-CART-009: Gộp sản phẩm trùng và tăng số lượng
...
Locator:  getByRole('row').filter({ hasText: 'Bàn phím cơ FR07' })
Expected: 1
Received: 2
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ hasText: 'Bàn phím cơ FR07' })
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - table [ref=e13]:
        ...
        - rowgroup [ref=e21]:
          - row [ref=e22]:
            - cell "Bàn phím cơ FR07" [ref=e23]
            - cell "123,456 ₫" [ref=e24]
            - cell "1" [ref=e25]
            - cell "123,456 ₫" [ref=e26]
            - cell [ref=e27]:
              - button "Xóa" [ref=e28] [cursor=pointer]
          - row [ref=e29]:
            - cell "Bàn phím cơ FR07" [ref=e30]
            - cell "123,456 ₫" [ref=e31]
            - cell "1" [ref=e32]
            - cell "123,456 ₫" [ref=e33]
            - cell [ref=e34]:
              - button "Xóa" [ref=e35] [cursor=pointer]
      - generic [ref=e36]:
        - generic [ref=e37]:
          - text: "Tổng tạm tính:"
          - generic [ref=e38]: 246,912 ₫
        - generic [ref=e39]:
