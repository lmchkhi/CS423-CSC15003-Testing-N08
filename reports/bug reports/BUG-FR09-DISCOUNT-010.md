# BUG-FR09-DISCOUNT-010: Mã SAVE10 không được áp dụng đúng tại giá trị tối thiểu
...
5. Thêm vào giỏ hàng sản phẩm Dây sạc điện thoại Apple chính hãng
6. Nhấn vào mục xem giỏ hàng
7. Nhấn vào Tiến hành thanh toán
8. Nhập vào mục Mã giảm giá và nhập mã: SAVE10
9. Nhấn vào Áp dụng
10. Nhấn vào Xác nhận thanh toán

## Expected result

Khi thực hiện xong bước 7 thì giao diện hiện tổng mới là 270000
...
![Tạo sản phẩm dây sạc điện thoại](tests/test-runs/FR09/assets/image-17.png)

## Kết quả

Ảnh áp dụng mã giảm giá trên giao diện web:

![Kết quả thực hiện](tests/test-runs/FR09/assets/image-18.png)

Ảnh trên giao diện admin:

![Ảnh trên giao diện admin](tests/test-runs/FR09/assets/image-19.png)
