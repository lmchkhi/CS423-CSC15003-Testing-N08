# BUG-FR15-PRODUCTEDIT-015: Hệ thống không chặn cập nhật sản phẩm khi giá rỗng

## Found by Test Case
TC-FR15-ProductEdit-015
...
- Hệ thống không ghi nhận thay đổi của sản phẩm và thông báo cần phải nhập giá
...
![Ảnh trước khi chỉnh sửa](tests/test-runs/FR15/assets/image-45.png)

Ảnh sau khi chỉnh sửa sản phẩm:
![Ảnh sau khi chỉnh sửa sản phẩm](tests/test-runs/FR15/assets/image-46.png)

Ảnh giao diện người dùng sau khi chỉnh sửa sản phẩm:
![Ảnh giao diện người dùng](tests/test-runs/FR15/assets/image-47.png)
