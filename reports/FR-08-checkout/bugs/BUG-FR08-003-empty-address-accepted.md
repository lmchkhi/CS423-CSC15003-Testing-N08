...
| Network / result summary | `reports/FR-08-checkout/evidence/phase-a-api-results.md`, `phase-c-run.md`, `phase-d-run.md` | Response/order count thật |
| HTML report | `reports/FR-08-checkout/playwright-report/index.html` | `DT-010` fail trên ba project |
