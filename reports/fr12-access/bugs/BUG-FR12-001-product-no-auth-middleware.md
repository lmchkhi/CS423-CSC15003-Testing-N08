...
| Thời điểm | `2026-08-07T08:59:03.516Z` |
...
| Network / result summary | `reports/fr12-access/evidence/phase-a-api-results.md`, `phase-d-run.md` | Response thật; bí mật không ghi vào evidence. |
| HTML report | `reports/fr12-access/playwright-report/index.html` | Sáu TC-ID fail trên Chromium, Firefox và Edge. |
