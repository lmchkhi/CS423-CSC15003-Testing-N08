...
| Network / result summary | `reports/fr12-access/evidence/phase-a-api-results.md`, `phase-d-run.md` | Bảy failure được tái hiện, expected không đổi. |
| HTML report | `reports/fr12-access/playwright-report/index.html` | Bảy TC-ID fail trên ba project. |
