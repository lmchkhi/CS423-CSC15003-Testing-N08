...
| Network / result summary | `reports/fr12-access/evidence/phase-a-api-results.md`, `phase-d-run.md` | Expected 401/actual 403 được ghi từ run thật. |
| HTML report | `reports/fr12-access/playwright-report/index.html` | DT-002 fail trên ba project. |
