...
| Network / result summary | `reports/fr12-access/evidence/phase-a-api-results.md`, `phase-d-run.md` | Control no-token phân biệt root cause với Product API. |
| HTML report | `reports/fr12-access/playwright-report/index.html` | Ba TC-ID fail trên ba project. |
