...
> Đây là phân tích lịch sử của Phase D. Raw evidence hiện hành là schema rerun `tests/api-testing/evidence/fr-11/20260822-schema-rerun-final/`: 80 ca, 60 đạt, 20 không đạt, 189 assertions (167 đạt, 22 không đạt).
