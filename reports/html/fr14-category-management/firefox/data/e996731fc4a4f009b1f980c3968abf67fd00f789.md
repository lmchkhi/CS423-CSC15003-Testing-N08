...
```
Error: User token must not rename category 57
...
```
Error: Unauthorized update "FR14 User Updated 20260809T17380 2" must not be applied

expect(received).toBeFalsy()

Received: {"id": 57, "name": "FR14 User Updated 20260809T17380 2"}
```
