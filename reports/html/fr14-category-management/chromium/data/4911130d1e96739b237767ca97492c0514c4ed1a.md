...
- Name: fr14-category-management.spec.ts >> Run by: 23127475 | FR-14 - Quản lý danh mục >> TC-FR14-DT-007 - Admin thêm danh mục với tên rỗng
...
Received string:      "{\"message\":\"Category created\",\"id\":19}"
```
