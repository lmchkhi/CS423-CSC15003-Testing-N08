...
Received string:      "{\"message\":\"Category created\",\"id\":27}"
```

```
Error: Category FR14 User Create 20260809T17361 2 must not be created

expect(received).toBeFalsy()

Received: {"id": 27, "name": "FR14 User Create 20260809T17361 2"}
```
