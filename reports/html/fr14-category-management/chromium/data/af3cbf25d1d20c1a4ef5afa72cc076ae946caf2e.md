...
- Name: fr14-category-management.spec.ts >> Run by: 23127475 | FR-14 - Quản lý danh mục >> TC-FR14-DT-013 - User thường không được cập nhật danh mục qua API
...
```
Error: User token must not rename category 37
...
```
Error: Unauthorized update "FR14 User Updated 20260809T17364 2" must not be applied

expect(received).toBeFalsy()

Received: {"id": 37, "name": "FR14 User Updated 20260809T17364 2"}
```
