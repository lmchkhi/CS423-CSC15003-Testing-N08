...
Locator:  getByRole('row').filter({ has: getByRole('cell', { name: '#167', exact: true }) }).getByRole('button', { name: 'Hủy đơn', exact: true })
Expected: 0
Received: 1
Timeout:  10000ms
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByRole('cell', { name: '#167', exact: true }) }).getByRole('button', { name: 'Hủy đơn', exact: true })
      ...
      - generic [ref=f1e13]:
        ...
        - generic [ref=f1e15]:
          - generic [ref=f1e16]:
            ...
            - textbox [disabled] [ref=f1e18]: fr10-1786200750378-552@eshop.test
          - generic [ref=f1e19]:
