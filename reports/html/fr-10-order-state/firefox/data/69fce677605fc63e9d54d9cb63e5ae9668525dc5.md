...
Locator: getByRole('row').filter({ has: getByRole('cell', { name: '#25', exact: true }) }).getByRole('button')
Timeout: 10000ms
- Expected  - 1
+ Received  + 3
...
Call log:
  ...
  - waiting for getByRole('row').filter({ has: getByRole('cell', { name: '#25', exact: true }) }).getByRole('button')
