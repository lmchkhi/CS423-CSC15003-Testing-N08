...
- Name: fr03-forgot-password.spec.ts >> Run by: 23127475 | FR-03 - Quên mật khẩu >> TC-FR03-DT-003 - Lấy OTP với email rỗng
...
Timeout: 5000ms
Expected pattern: /bắt buộc|required|không được để trống|vui lòng nhập/i
Received string:  "
