...
- Name: fr03-forgot-password.spec.ts >> Run by: 23127475 | FR-03 - Quên mật khẩu >> TC-FR03-DT-005 - Lấy OTP với email chưa đăng ký
...
Timeout: 5000ms
Expected pattern: /không tồn tại|chưa đăng ký|not found|User not found/i
Received string:  "
...
- main:
  ...
  - textbox: notfound.fr03@example.com
  - button "Lấy mã OTP"
