...
- Name: fr03-forgot-password.spec.ts >> Run by: 23127475 | FR-03 - Quên mật khẩu >> TC-FR03-DT-002 - Kiểm tra nút Quay lại đăng nhập ở bước lấy OTP
...
Locator: getByRole('button', { name: /quay lại.*đăng nhập|back.*login/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /quay lại.*đăng nhập|back.*login/i }).first()
