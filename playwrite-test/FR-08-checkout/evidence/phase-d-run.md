...
- Runtime timestamp trong HTML report: `06/08/2026 10:23`
- Run by: `23127464`
...
- Report: `playwrite-test/FR-08-checkout/playwright-report/index.html`.
- Đường dẫn tuyệt đối: `E:\Testing\CS423-CSC15003-Testing-N08\playwrite-test\FR-08-checkout\playwright-report\index.html`.
- Document title lịch sử sau khi mở thật có `Run by: 23127464`; thời gian quy đổi là `06/08/2026 10:23`.
- Nội dung render đầu report: `All 45`, `Passed 12`, `Failed 33`, `Skipped 0` và cùng tiêu đề trên.
- Kiểm chứng lịch sử: `run_by_visible=true`, `runtime_label_visible=true`; thời gian hiển thị quy đổi là `06/08/2026 10:23`, ISO gốc nằm trong report lịch sử.
