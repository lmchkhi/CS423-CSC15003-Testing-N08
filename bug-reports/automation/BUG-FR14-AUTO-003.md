...
title: "[BUG][FR-14] API cập nhật danh mục không tồn tại vẫn trả thành công"
...
4. Gọi `GET /api/categories` để kiểm tra danh sách.

## Expected result
API phải trả lỗi phù hợp như `400`, `404` hoặc `422`, hoặc thông báo category không tồn tại. Hệ thống không được báo cập nhật thành công khi không có record nào bị ảnh hưởng.

## Actual result
API trả `200 OK` với body:
...
Không có category mới được tạo, nhưng response success gây hiểu sai rằng thao tác update đã thực hiện thành công.
...
- Screenshot Evidence: [`test-results/fr14-category-management/chromium/fr14-category-management-R-6fc1b-nhật-danh-mục-không-tồn-tại-chromium/test-failed-1.png`](../../test-results/fr14-category-management/chromium/fr14-category-management-R-6fc1b-nhật-danh-mục-không-tồn-tại-chromium/test-failed-1.png)

![Screenshot Evidence](../../test-results/fr14-category-management/chromium/fr14-category-management-R-6fc1b-nhật-danh-mục-không-tồn-tại-chromium/test-failed-1.png)
