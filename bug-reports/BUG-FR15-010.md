...
Hệ thống ghi nhận thay đổi và cập nhật lại giá của sản phẩm rỗng. Giao diện của admin hiện giá rỗng và người dùng đểu hiện thông tin sản phẩm giá bằng 0.
