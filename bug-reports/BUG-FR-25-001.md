# BUG-FR-25-001: Màn hình đăng ký mobile không hiển thị trường Xác nhận mật khẩu nhưng vẫn cho phép đăng ký thành công

## Found by Test Case
TC-FR-25-001

## Requirement liên quan
FR-25: Đăng ký tài khoản (Mobile)
...
## Actual result
Màn hình đăng ký không có trường `Xác nhận mật khẩu` theo yêu cầu FR-25, nhưng hệ thống vẫn cho phép đăng ký thành công.
