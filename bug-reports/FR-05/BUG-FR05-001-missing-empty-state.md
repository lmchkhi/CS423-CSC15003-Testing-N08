...
- URL/Issue ID: `#220` — https://github.com/lmchkhi/CS423-CSC15003-Testing-N08/issues/220
- Screenshot Issue: [Mở ảnh](<../screenshots_issues/FR-05/[BUG][FR-05 Search] Không hiển thị empty state khi tìm kiếm không có kết quả.png>)

![GitHub Issue #220](<../screenshots_issues/FR-05/[BUG][FR-05 Search] Không hiển thị empty state khi tìm kiếm không có kết quả.png>)
