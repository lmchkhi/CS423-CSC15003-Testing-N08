...
The SUT ships an API specification in the repository ([api_specification.md](/api_specification.md)); consult it for the available endpoints. The specification also defines security requirements SEC-01–SEC-07.
