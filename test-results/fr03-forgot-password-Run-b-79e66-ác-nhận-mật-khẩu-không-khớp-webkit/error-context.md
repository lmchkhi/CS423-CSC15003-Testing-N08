...
Received string:  "
    EShopGiỏ hàngĐăng nhậpĐăng kýQuên Mật KhẩuMã OTP của bạn là: 9679Mã OTP (4 số)Mật khẩu mớiĐặt lại mật khẩu← Quay lại© 2026 EShop SUT. Dành cho mục đích kiểm thử.·········
"
...
- main:
  ...
  - text: "Mã OTP của bạn là: 9679 Mã OTP (4 số)"
  - textbox: "123456"
  - text: Mật khẩu mới
  - textbox: NewPass123!
