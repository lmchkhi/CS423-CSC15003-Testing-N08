...
- Name: fr03-forgot-password.spec.ts >> Run by: 23127475 | FR-03 - Quên mật khẩu >> TC-FR03-DT-011 - Đặt lại mật khẩu khi xác nhận mật khẩu không khớp
...
Timeout: 5000ms
Expected pattern: /không khớp|mismatch|confirm|xác nhận/i
Received string:  "
    EShopGiỏ hàngĐăng nhậpĐăng kýQuên Mật KhẩuMã OTP của bạn là: 3364Mã OTP (4 số)Mật khẩu mớiĐặt lại mật khẩu← Quay lại© 2026 EShop SUT. Dành cho mục đích kiểm thử.·········
"
...
- main:
  ...
  - text: "Mã OTP của bạn là: 3364 Mã OTP (4 số)"
  - textbox: "123456"
  - text: Mật khẩu mới
  - textbox: NewPass123!
