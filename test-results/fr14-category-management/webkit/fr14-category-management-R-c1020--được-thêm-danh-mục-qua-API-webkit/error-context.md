...
Received string:      "{\"message\":\"Category created\",\"id\":87}"
```

```
Error: Category FR14 User Create 20260809T17413 2 must not be created

expect(received).toBeFalsy()

Received: {"id": 87, "name": "FR14 User Create 20260809T17413 2"}
```
