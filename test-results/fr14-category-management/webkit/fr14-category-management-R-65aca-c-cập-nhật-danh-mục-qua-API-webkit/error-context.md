...
```
Error: User token must not rename category 97
...
```
Error: Unauthorized update "FR14 User Updated 20260809T17420 2" must not be applied

expect(received).toBeFalsy()

Received: {"id": 97, "name": "FR14 User Updated 20260809T17420 2"}
```
