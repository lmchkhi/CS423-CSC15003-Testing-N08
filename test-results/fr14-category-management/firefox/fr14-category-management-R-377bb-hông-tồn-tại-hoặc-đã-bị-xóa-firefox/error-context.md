...
- Name: fr14-category-management.spec.ts >> Run by: 23127475 | FR-14 - Quản lý danh mục >> TC-FR14-DT-015 - Admin xóa danh mục không tồn tại hoặc đã bị xóa
...
> 748 |   expect.soft(text).not.toMatch(textPattern(testCase.expected.bodyMustNotContainPattern));
  ...
  803 |     await expect.soft(body).not.toContainText(/404|not found|typeerror|exception/i);
  804 |
