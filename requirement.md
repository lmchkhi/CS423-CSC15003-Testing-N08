...
SUT EShop is a Vietnamese e-commerce demo application designed for testing practice.
...
- FR01 Account registration
- FR02 Login and account lockout
- FR03 Forgot password and password reset (two steps)
- FR04 Personal profile management
- FR05 Product listing and search
- FR06 Product detail view

#### Pool B: Shopping Cart and Checkout

- FR07 Shopping cart
- FR08 Checkout
- FR09 Discount coupons
- FR10 Order state machine
- FR11 Order history view (user)
...
- FR15 Product management CRUD
- FR16 Product import from CSV
- FR17 Coupon management CRUD
- FR18 Order management (admin)
- FR19 User management (admin)

#### Pool D: Mobile App

### 5. Feature Selection

Within each group, every student must select four features, one from each pool, and ensure that no feature is duplicated among the members of the group.
...
Submit the skills together with demonstration video(s) and YouTube links that show, end to end, how you used the skills on a complete feature.

### 8. Allowed Tools and Bloom-AI Level

You may use the following tools, and you must declare them in your AI Audit Report:

- Any AI tool of your choice, for example ChatGPT, Claude, Gemini, Copilot, or Cursor.
- Optional AI test-generation tools, for example Diffblue, for cross-checking.
...
Write a paragraph of 200-300 words critiquing the AI. Address the following questions:
...
SelfAssessedGrade is a 3-digit number in the range 000-100.
...
- `README.md` containing the self-assessment table and a test summary report: number of features; number of test cases designed, executed, passed, failed, and not yet executed; number of bugs; and demo videos.
