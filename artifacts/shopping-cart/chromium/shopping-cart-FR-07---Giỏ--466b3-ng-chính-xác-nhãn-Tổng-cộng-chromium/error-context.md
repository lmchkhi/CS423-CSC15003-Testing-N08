...
- Name: shopping-cart.spec.mjs >> FR-07 - Giỏ hàng >> TC-CART-007: Dùng chính xác nhãn Tổng cộng
...
Locator: locator('main .text-xl.font-bold')
Expected substring: "Tổng cộng:"
Received string:    "Tổng tạm tính: 123,456 ₫"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('main .text-xl.font-bold')
    13 × locator resolved to <div class="text-xl font-bold">…</div>
       - unexpected value "Tổng tạm tính: 123,456 ₫"
