...
- Name: shopping-cart.spec.mjs >> FR-07 - Giỏ hàng >> TC-CART-002: Hiển thị hình minh họa khi giỏ hàng trống
...
Locator:  locator('main img, main svg, main [role="img"]')
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('main img, main svg, main [role="img"]')
