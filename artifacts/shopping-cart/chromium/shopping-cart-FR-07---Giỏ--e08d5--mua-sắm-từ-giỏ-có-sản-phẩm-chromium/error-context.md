...
- Name: shopping-cart.spec.mjs >> FR-07 - Giỏ hàng >> TC-CART-014: Tiếp tục mua sắm từ giỏ có sản phẩm
...
Locator: getByRole('link', { name: 'Tiếp tục mua sắm', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Tiếp tục mua sắm', exact: true })
