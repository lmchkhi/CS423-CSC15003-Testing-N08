# TC-FR09-API-SEC-008: Extra role field không escalation privilege
...
| Request body/query/path | `{"code":"SAVE10","total_amount":500000,"user_id":{{userId}},"role":"admin"}` |
...
- Response body/headers/assertions: Nếu accepted thì discount như user thường; nếu rejected thì client error; không admin/internal fields.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Raw status mơ hồ; giữ làm security hardening, assertion chính là không privilege escalation.
...
| Data row key | `TC-FR09-API-SEC-008` |
