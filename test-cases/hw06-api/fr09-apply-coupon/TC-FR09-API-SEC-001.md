# TC-FR09-API-SEC-001: Thiếu Authorization header
...
- Rationale: FR-09 C4 và SEC-02 yêu cầu JWT hợp lệ.
...
| Data row key | `TC-FR09-API-SEC-001` |
...
Related bug report: `reports/bug-reports/BUG-FR09-API-003.md`
