# TC-FR09-API-WF-002: VIP100 lần dùng thứ nhất thành công
...
- User logged in; VIP100 usage count = 0.
...
| Request body/query/path | `{"code":"VIP100","total_amount":500000,"user_id":{{userId}}}` |
...
- HTTP status: `200`.
- Response body/headers/assertions: discount_amount=100000; final_amount=400000.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: VIP100 max_uses_per_user = 2.
...
| Data row key | `TC-FR09-API-WF-002` |
