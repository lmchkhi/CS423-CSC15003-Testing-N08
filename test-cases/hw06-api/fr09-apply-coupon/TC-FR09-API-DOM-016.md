# TC-FR09-API-DOM-016: total_amount là null
...
| Request body/query/path | `{"code":"SAVE10","total_amount":null,"user_id":{{userId}}}` |
...
- Rationale: Null amount không thể tính toán.
...
| Data row key | `TC-FR09-API-DOM-016` |
