# TC-FR09-API-WF-004: VIP100 lần dùng thứ ba cùng user bị reject
...
- Same user đã dùng VIP100 hai lần.
...
- Rationale: Usage count không còn < max_uses_per_user.
...
| Data row key | `TC-FR09-API-WF-004` |
