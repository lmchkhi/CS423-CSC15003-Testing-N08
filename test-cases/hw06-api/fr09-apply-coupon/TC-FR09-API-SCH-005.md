# TC-FR09-API-SCH-005: Error response cho missing code có shape an toàn
...
- HTTP status: `400`.
- Response body/headers/assertions: message hoặc error string; không stack/sql trace.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Negative response schema ổn định và không leak internal detail.
...
| Data row key | `TC-FR09-API-SCH-005` |
