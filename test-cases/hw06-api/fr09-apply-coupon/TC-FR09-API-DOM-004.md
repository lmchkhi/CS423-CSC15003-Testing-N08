# TC-FR09-API-DOM-004: SAVE10 ở đúng ngưỡng tối thiểu
...
| Request body/query/path | `{"code":"SAVE10","total_amount":300000,"user_id":{{userId}}}` |
...
- HTTP status: `200`.
- Response body/headers/assertions: discount_amount=30000; final_amount=270000.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: C3 yêu cầu >= min_order_amount.
...
| Data row key | `TC-FR09-API-DOM-004` |
