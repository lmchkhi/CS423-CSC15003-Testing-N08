# TC-FR09-API-DOM-001: Apply SAVE10 percent coupon với total hợp lệ trên min
...
- User logged in; body user_id thuộc token user; SAVE10 chưa dùng bởi user này.
...
- HTTP status: `200`.
- Response body/headers/assertions: discount_amount=50000; final_amount=450000.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: FR-09 C1-C5 và công thức percent: 10% của 500000.
...
| Data row key | `TC-FR09-API-DOM-001` |
