# TC-FR09-API-DOM-010: code là null
...
| Request body/query/path | `{"code":null,"total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: Null code không thể thỏa C1.
...
| Data row key | `TC-FR09-API-DOM-010` |
