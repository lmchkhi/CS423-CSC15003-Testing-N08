# TC-FR09-API-SEC-009: Success response không leak token/password/role
...
- HTTP status: `200`.
- Response body/headers/assertions: Không có password, password_hash, token, role.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Response apply-coupon chỉ nên trả public calculation fields.
...
| Data row key | `TC-FR09-API-SEC-009` |
