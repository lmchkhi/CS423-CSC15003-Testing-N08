# TC-FR09-API-DOM-018: total_amount âm
...
| Request body/query/path | `{"code":"SAVE10","total_amount":-1,"user_id":{{userId}}}` |
...
- HTTP status: `400`.
- Response body/headers/assertions: message hoặc error; final_amount không âm.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Negative amount là partition invalid.
...
| Data row key | `TC-FR09-API-DOM-018` |
