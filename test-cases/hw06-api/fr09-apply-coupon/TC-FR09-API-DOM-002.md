# TC-FR09-API-DOM-002: Apply BIGBUY fixed coupon ở đúng min_order_amount
...
- User logged in; BIGBUY chưa dùng bởi user này.
...
| Request body/query/path | `{"code":"BIGBUY","total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: Boundary C3: total_amount bằng min_order_amount vẫn hợp lệ.
...
| Data row key | `TC-FR09-API-DOM-002` |
