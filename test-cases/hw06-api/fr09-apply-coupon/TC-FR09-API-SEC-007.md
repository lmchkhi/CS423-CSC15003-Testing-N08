# TC-FR09-API-SEC-007: XSS-like payload trong code không reflect nguy hiểm
...
| Request body/query/path | `{"code":"<script>alert(1)</script>","total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: SEC-04/SEC-05 safe handling cho user input.
...
| Data row key | `TC-FR09-API-SEC-007` |
