# TC-FR09-API-WF-005: Usage limit tính theo từng user, không phải global
...
- User A đã dùng SAVE10; login user B.
...
| Request body/query/path | `User B apply SAVE10 với own user_id` |
...
- Rationale: C5 là số lần dùng của user.
...
| Data row key | `TC-FR09-API-WF-005` |
