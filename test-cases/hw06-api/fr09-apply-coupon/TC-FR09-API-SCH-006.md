# TC-FR09-API-SCH-006: GET /api/apply-coupon không thành công
...
- Response body/headers/assertions: Không trả success schema discount_amount/final_amount.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: API spec chỉ định POST.
...
| Data row key | `TC-FR09-API-SCH-006` |
