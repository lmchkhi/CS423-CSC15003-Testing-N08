# TC-FR09-API-WF-003: VIP100 lần dùng thứ hai cùng user vẫn thành công
...
- Same user đã dùng VIP100 một lần.
...
| Request body/query/path | `Same VIP100 body` |
...
- Rationale: Usage count 1 vẫn < max 2.
...
| Data row key | `TC-FR09-API-WF-003` |
