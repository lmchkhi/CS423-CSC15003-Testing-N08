# TC-FR09-API-DOM-006: BIGBUY thấp hơn min_order_amount 1 đơn vị
...
| Request body/query/path | `{"code":"BIGBUY","total_amount":499999,"user_id":{{userId}}}` |
...
- Rationale: Fixed coupon vẫn phải thỏa C3.
...
| Data row key | `TC-FR09-API-DOM-006` |
