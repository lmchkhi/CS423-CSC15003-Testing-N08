# TC-FR09-API-SCH-002: Success response có discount_amount/final_amount dạng number
...
- User logged in; BIGBUY body hợp lệ.
...
| Request body/query/path | `Valid BIGBUY body` |
...
- HTTP status: `200`.
- Response body/headers/assertions: discount_amount:number; final_amount:number.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: API spec nêu 2 field calculation output.
...
| Data row key | `TC-FR09-API-SCH-002` |
