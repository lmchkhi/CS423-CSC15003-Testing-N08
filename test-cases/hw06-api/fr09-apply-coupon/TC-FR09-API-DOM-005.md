# TC-FR09-API-DOM-005: SAVE10 thấp hơn min_order_amount 1 đơn vị
...
| Request body/query/path | `{"code":"SAVE10","total_amount":299999,"user_id":{{userId}}}` |
...
- Rationale: Boundary ngay dưới C3 phải bị reject.
...
| Data row key | `TC-FR09-API-DOM-005` |
