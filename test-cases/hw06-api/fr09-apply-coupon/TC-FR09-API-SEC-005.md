# TC-FR09-API-SEC-005: SQL injection payload trong code không gây 500/leak
...
| Request body/query/path | `{"code":"' OR '1'='1","total_amount":500000,"user_id":{{userId}}}` |
...
| Data row key | `TC-FR09-API-SEC-005` |
