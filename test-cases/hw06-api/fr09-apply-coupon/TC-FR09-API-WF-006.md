# TC-FR09-API-WF-006: Failed below-min attempt không consume usage
...
| Request body/query/path | `First total 299999, then total 500000` |
...
- Rationale: Failed C3 không nên count là đã dùng coupon.
...
| Data row key | `TC-FR09-API-WF-006` |
