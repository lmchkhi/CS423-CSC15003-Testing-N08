# TC-FR09-API-DOM-020: Thiếu user_id
...
| Request body/query/path | `{"code":"SAVE10","total_amount":500000}` |
...
- Rationale: API spec có body user_id; request thiếu field phải bị reject.
...
| Data row key | `TC-FR09-API-DOM-020` |
