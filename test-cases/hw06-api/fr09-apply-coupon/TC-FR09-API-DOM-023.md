# TC-FR09-API-DOM-023: user_id sai kiểu string numeric
...
| Request body/query/path | `{"code":"SAVE10","total_amount":500000,"user_id":"1"}` |
...
- Rationale: Wrong type cho user_id phải bị reject thay vì coerce mơ hồ.
...
| Data row key | `TC-FR09-API-DOM-023` |
...
| Human reasoning | AI có SQLi string user_id nhưng bỏ sót string numeric trông hợp lệ. |
| Why AI missed it | AI có SQLi string user_id nhưng bỏ sót string numeric trông hợp lệ. |

## Status / Related bugs

`Failed`

Related bug report: `reports/bug-reports/BUG-FR09-API-005.md`
