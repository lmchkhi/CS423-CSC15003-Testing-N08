# TC-FR09-API-DOM-009: Thiếu field code
...
| Request body/query/path | `{"total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: code là required field theo API spec.
...
| Data row key | `TC-FR09-API-DOM-009` |
