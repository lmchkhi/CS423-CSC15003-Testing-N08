# TC-FR09-API-SCH-008: Valid coupon response time dưới 1000ms
...
| Request body/query/path | `Valid SAVE10 hoặc BIGBUY body` |
...
- HTTP status: `200`.
- Response body/headers/assertions: Response time < 1000ms; calculation đúng.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Contract/performance assertion cho Newman.
...
| Data row key | `TC-FR09-API-SCH-008` |
