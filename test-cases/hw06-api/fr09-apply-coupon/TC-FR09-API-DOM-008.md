# TC-FR09-API-DOM-008: Unknown coupon code bị reject
...
| Request body/query/path | `{"code":"NOTREAL","total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: C1 yêu cầu mã tồn tại/active; raw status 400 hoặc 404 được sửa thành client error 4xx.
...
| Data row key | `TC-FR09-API-DOM-008` |
