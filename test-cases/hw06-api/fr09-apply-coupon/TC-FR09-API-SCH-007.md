# TC-FR09-API-SCH-007: Malformed JSON body trả client error không leak stack
...
| Request body/query/path | `Raw body { "code": "SAVE10",` |
...
- HTTP status: `400`.
- Response body/headers/assertions: Error response safe; không stack/sql leak.
...
| Data row key | `TC-FR09-API-SCH-007` |
