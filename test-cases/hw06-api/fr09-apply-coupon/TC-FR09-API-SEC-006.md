# TC-FR09-API-SEC-006: SQL injection-like payload trong user_id không gây 500/leak
...
| Request body/query/path | `{"code":"SAVE10","total_amount":500000,"user_id":"1 OR 1=1"}` |
...
- Rationale: Wrong type + SQLi không được crash/leak.
...
| Data row key | `TC-FR09-API-SEC-006` |
