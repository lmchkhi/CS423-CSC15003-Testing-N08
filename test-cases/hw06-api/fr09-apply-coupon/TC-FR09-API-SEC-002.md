# TC-FR09-API-SEC-002: Authorization header malformed: Bearer không có token
...
- Rationale: Malformed token không phải JWT hợp lệ.
...
| Data row key | `TC-FR09-API-SEC-002` |
