# TC-FR09-API-DOM-022: user_id là null
...
| Request body/query/path | `{"code":"SAVE10","total_amount":500000,"user_id":null}` |
...
- Rationale: Null user_id không xác định được owner/usage quota.
...
| Data row key | `TC-FR09-API-DOM-022` |
...
| Human reasoning | AI có missing user_id và IDOR nhưng bỏ sót null partition. |
| Why AI missed it | AI có missing user_id và IDOR nhưng bỏ sót null partition. |
