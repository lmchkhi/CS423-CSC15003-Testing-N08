# TC-FR09-API-DOM-007: EXPIRED coupon với total đủ cao vẫn bị reject
...
| Request body/query/path | `{"code":"EXPIRED","total_amount":200000,"user_id":{{userId}}}` |
...
- Rationale: C2: ngày hiện tại phải trước expired_at.
...
| Data row key | `TC-FR09-API-DOM-007` |
