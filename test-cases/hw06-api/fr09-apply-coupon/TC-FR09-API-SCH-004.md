# TC-FR09-API-SCH-004: Fixed coupon calculation exact với total lớn hơn min
...
- User logged in; BIGBUY chưa dùng.
...
| Request body/query/path | `{"code":"BIGBUY","total_amount":600000,"user_id":{{userId}}}` |
...
- HTTP status: `200`.
- Response body/headers/assertions: discount_amount=50000; final_amount=550000.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Fixed discount không phụ thuộc total ngoài min threshold.
...
| Data row key | `TC-FR09-API-SCH-004` |
