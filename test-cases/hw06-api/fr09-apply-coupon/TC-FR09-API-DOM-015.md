# TC-FR09-API-DOM-015: Thiếu total_amount
...
| Request body/query/path | `{"code":"SAVE10","user_id":{{userId}}}` |
...
- Rationale: total_amount cần cho C3 và công thức discount.
...
| Data row key | `TC-FR09-API-DOM-015` |
