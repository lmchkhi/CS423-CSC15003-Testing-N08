# TC-FR09-API-DOM-013: Lowercase coupon code save10 bị reject nếu code case-sensitive
...
- Rationale: Spec chỉ nêu sample code SAVE10; raw expected mơ hồ được sửa thành case-sensitive boundary 4xx.
...
| Data row key | `TC-FR09-API-DOM-013` |
