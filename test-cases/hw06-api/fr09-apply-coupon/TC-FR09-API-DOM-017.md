# TC-FR09-API-DOM-017: total_amount bằng 0
...
| Request body/query/path | `{"code":"SAVE10","total_amount":0,"user_id":{{userId}}}` |
...
- Rationale: 0 không thỏa min_order_amount.
...
| Data row key | `TC-FR09-API-DOM-017` |
