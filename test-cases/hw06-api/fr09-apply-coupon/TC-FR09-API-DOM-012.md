# TC-FR09-API-DOM-012: code là whitespace-only
...
| Request body/query/path | `{"code":"   ","total_amount":500000,"user_id":{{userId}}}` |
...
- Rationale: Whitespace-only code không được match coupon.
...
| Data row key | `TC-FR09-API-DOM-012` |
