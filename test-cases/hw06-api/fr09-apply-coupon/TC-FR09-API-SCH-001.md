# TC-FR09-API-SCH-001: Success response có Content-Type JSON
...
- User logged in; SAVE10 body hợp lệ.
...
- HTTP status: `200`.
- Response body/headers/assertions: Header Content-Type chứa application/json.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Contract response là JSON.
...
| Data row key | `TC-FR09-API-SCH-001` |
