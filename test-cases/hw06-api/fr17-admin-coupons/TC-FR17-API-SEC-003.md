# TC-FR17-API-SEC-003: JWT token invalid
...
- Rationale: Invalid JWT phải bị reject.
...
| Data row key | `TC-FR17-API-SEC-003` |
...
Related bug report: `reports/bug-reports/BUG-FR17-API-004.md`
