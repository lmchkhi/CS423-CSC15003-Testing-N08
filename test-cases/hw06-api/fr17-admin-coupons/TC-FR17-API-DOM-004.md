# TC-FR17-API-DOM-004: `code` là null
...
| Request body/query/path | `{"code":null,"type":"percent","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Null code không thỏa required unique code.
...
| Data row key | `TC-FR17-API-DOM-004` |
