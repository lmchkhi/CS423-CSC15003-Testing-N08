# TC-FR17-API-DOM-015: `discount_value` âm
...
| Request body/query/path | `{"code":"HW06DISCNEG{{runId}}","type":"percent","discount_value":-1,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Giá trị âm vi phạm positive constraint.
...
| Data row key | `TC-FR17-API-DOM-015` |
