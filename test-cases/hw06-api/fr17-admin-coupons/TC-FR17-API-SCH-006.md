# TC-FR17-API-SCH-006: GET `/api/admin/coupons` không thành công như create endpoint
...
| Request body/query/path | No body |
...
- HTTP status: `404 hoặc 405`.
- Response body/headers/assertions: Không tạo coupon; không trả create success schema.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: API spec chỉ liệt kê POST cho `/api/admin/coupons` create.
...
| Data row key | `TC-FR17-API-SCH-006` |
