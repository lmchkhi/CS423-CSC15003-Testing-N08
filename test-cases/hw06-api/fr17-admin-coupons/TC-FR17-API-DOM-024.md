# TC-FR17-API-DOM-024: Thiếu field `max_uses_per_user`
...
| Request body/query/path | Body không có `max_uses_per_user` |
...
- Rationale: FR-17 yêu cầu `max_uses_per_user`.
...
| Data row key | `TC-FR17-API-DOM-024` |
