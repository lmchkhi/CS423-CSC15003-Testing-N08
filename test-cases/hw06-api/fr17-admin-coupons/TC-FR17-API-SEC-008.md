# TC-FR17-API-SEC-008: Extra `role:"admin"` không giúp user token create coupon
...
| Request body/query/path | Valid coupon body plus `"role":"admin"` với user token |
...
- Rationale: Client-controlled role không được ảnh hưởng SEC-03 authorization.
...
| Data row key | `TC-FR17-API-SEC-008` |
