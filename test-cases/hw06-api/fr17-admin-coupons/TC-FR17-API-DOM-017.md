# TC-FR17-API-DOM-017: Thiếu field `min_order_amount`
...
| Request body/query/path | Body không có `min_order_amount` |
...
- Rationale: FR-17 yêu cầu `min_order_amount`.
...
| Data row key | `TC-FR17-API-DOM-017` |
