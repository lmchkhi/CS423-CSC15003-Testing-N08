# TC-FR17-API-DOM-019: `min_order_amount` âm
...
| Request body/query/path | `{"code":"HW06MINNEG{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":-1,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
| Data row key | `TC-FR17-API-DOM-019` |
