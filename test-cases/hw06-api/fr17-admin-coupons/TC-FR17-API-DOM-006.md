# TC-FR17-API-DOM-006: `code` là whitespace-only
...
| Request body/query/path | `{"code":"   ","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Whitespace-only code không phải mã có ý nghĩa.
...
| Data row key | `TC-FR17-API-DOM-006` |
