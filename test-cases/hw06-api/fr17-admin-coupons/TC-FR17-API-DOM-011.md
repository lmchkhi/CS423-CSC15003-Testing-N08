# TC-FR17-API-DOM-011: `type` unsupported value
...
| Request body/query/path | `{"code":"HW06FREESHIP{{runId}}","type":"free_shipping","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: FR-17 chỉ cho phép `percent` hoặc `fixed`.
...
| Data row key | `TC-FR17-API-DOM-011` |
