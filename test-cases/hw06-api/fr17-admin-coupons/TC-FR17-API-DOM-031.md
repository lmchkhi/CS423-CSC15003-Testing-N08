# TC-FR17-API-DOM-031: `max_uses_per_user` là null
...
| Request body/query/path | `{"code":"HW06MAXNULL{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":null}` |
...
| Data row key | `TC-FR17-API-DOM-031` |
...
| Human reasoning | Human thêm để hoàn thiện null partition cho `max_uses_per_user`. |
| Why AI missed it | AI có missing/zero/string nhưng bỏ sót null max_uses_per_user. |
