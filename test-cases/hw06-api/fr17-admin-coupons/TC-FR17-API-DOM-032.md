# TC-FR17-API-DOM-032: `type` là empty string
...
| Request body/query/path | `{"code":"HW06TYPEEMPTY{{runId}}","type":"","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Empty string không thuộc enum `percent/fixed`.
...
| Data row key | `TC-FR17-API-DOM-032` |
...
| Human reasoning | Human thêm để cover empty enum value. |
| Why AI missed it | AI có missing/null/unsupported/wrong-case type nhưng bỏ sót empty string. |
