# TC-FR17-API-SCH-005: Unsupported `Content-Type: text/plain` không được xử lý như success
...
| Request body/query/path | Header `Content-Type: text/plain`; JSON-looking coupon body as text |
...
- Response body/headers/assertions: Không tạo coupon; không 5xx; error safe.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Request content-type negative case.
...
| Data row key | `TC-FR17-API-SCH-005` |
...
Related bug report: `reports/bug-reports/BUG-FR17-API-006.md`
