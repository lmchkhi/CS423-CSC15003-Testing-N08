# TC-FR17-API-DOM-016: `discount_value` sai kiểu string
...
| Request body/query/path | `{"code":"HW06DISCSTR{{runId}}","type":"fixed","discount_value":"50000","min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
| Data row key | `TC-FR17-API-DOM-016` |
