# TC-FR17-API-DOM-030: `min_order_amount` là null
...
| Request body/query/path | `{"code":"HW06MINNULL{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":null,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Null partition cho required number.
...
| Data row key | `TC-FR17-API-DOM-030` |
...
| Human reasoning | Human thêm để hoàn thiện null partition cho `min_order_amount`. |
| Why AI missed it | AI có missing/negative/string nhưng bỏ sót null min_order_amount. |
