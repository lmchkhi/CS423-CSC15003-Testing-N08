# TC-FR17-API-SCH-004: Malformed JSON body trả client error và không leak stack
...
| Request body/query/path | Raw body `{ "code": "HW06BAD",` |
...
- HTTP status: `400`.
- Response body/headers/assertions: Safe error response; không stack/sql leak.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Parser-level schema case.
...
| Data row key | `TC-FR17-API-SCH-004` |
...
Related bug report: `reports/bug-reports/BUG-FR17-API-005.md`
