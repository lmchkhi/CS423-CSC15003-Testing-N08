# TC-FR17-API-DOM-022: `expired_at` malformed date
...
| Request body/query/path | `{"code":"HW06BADDATE{{runId}}","type":"percent","discount_value":10,"min_order_amount":0,"expired_at":"31-12-2099","max_uses_per_user":1}` |
...
- Rationale: Sample dùng `YYYY-MM-DD`; malformed date cần bị reject.
...
| Data row key | `TC-FR17-API-DOM-022` |
