# TC-FR17-API-DOM-021: Thiếu field `expired_at`
...
| Request body/query/path | Body không có `expired_at` |
...
- Rationale: FR-17 yêu cầu `expired_at`.
...
| Data row key | `TC-FR17-API-DOM-021` |
