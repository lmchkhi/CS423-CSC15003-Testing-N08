# TC-FR17-API-DOM-013: Thiếu field `discount_value`
...
| Request body/query/path | Body không có `discount_value` |
...
- Rationale: FR-17 yêu cầu `discount_value` dương.
...
| Data row key | `TC-FR17-API-DOM-013` |
