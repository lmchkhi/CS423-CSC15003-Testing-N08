# TC-FR17-API-DOM-012: `type` sai case `Percent` bị reject
...
| Request body/query/path | `{"code":"HW06TYPECASE{{runId}}","type":"Percent","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Enum trong spec là lowercase `percent`/`fixed`.
...
| Data row key | `TC-FR17-API-DOM-012` |
...
| Human reasoning | Raw expected mơ hồ; sửa thành lowercase enum exact theo field rule blackbox. |
