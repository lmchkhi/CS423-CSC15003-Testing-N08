# TC-FR17-API-DOM-010: `type` là null
...
| Request body/query/path | `{"code":"HW06NULLTYPE{{runId}}","type":null,"discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Null type không thuộc enum.
...
| Data row key | `TC-FR17-API-DOM-010` |
