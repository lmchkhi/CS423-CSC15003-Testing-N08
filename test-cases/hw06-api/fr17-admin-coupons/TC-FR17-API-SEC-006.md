# TC-FR17-API-SEC-006: SQL injection payload trong `type` không bypass enum
...
| Request body/query/path | `{"code":"HW06SQLTYPE{{runId}}","type":"percent' OR '1'='1","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Enum `type` không được bị bypass bằng injection-like string.
...
| Data row key | `TC-FR17-API-SEC-006` |
