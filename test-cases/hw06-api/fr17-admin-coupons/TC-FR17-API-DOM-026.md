# TC-FR17-API-DOM-026: `max_uses_per_user` bằng 0
...
| Request body/query/path | `{"code":"HW06MAX0{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":0}` |
...
| Data row key | `TC-FR17-API-DOM-026` |
