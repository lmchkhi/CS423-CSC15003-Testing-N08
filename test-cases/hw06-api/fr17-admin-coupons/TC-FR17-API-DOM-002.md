# TC-FR17-API-DOM-002: Create valid fixed coupon với typical values
...
- Admin logged in; generated unique code `HW06FIX{{runId}}` chưa tồn tại.
...
| Request body/query/path | `{"code":"HW06FIX{{runId}}","type":"fixed","discount_value":50000,"min_order_amount":300000,"expired_at":"2099-12-31","max_uses_per_user":2}` |
...
- Rationale: Happy path cho fixed type.
...
| Data row key | `TC-FR17-API-DOM-002` |
