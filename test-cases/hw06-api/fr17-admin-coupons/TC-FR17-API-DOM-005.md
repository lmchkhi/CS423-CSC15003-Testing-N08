# TC-FR17-API-DOM-005: `code` là empty string
...
| Request body/query/path | `{"code":"","type":"percent","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Empty code không hợp lệ.
...
| Data row key | `TC-FR17-API-DOM-005` |
