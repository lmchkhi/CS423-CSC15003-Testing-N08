# TC-FR17-API-WF-007: Duplicate rejection không overwrite original coupon values
...
- Original coupon created with fixed discount.
...
| Request body/query/path | Duplicate create cùng code nhưng khác fields, sau đó list verify |
...
- HTTP status: `400/409 then 200`.
- Response body/headers/assertions: Original fields unchanged.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Uniqueness conflict không được mutate existing coupon.
...
| Data row key | `TC-FR17-API-WF-007` |
