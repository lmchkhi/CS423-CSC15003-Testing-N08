# TC-FR17-API-SCH-007: Response time cho valid create dưới 1000ms
...
- Admin logged in; unique valid body.
...
| Request body/query/path | Valid fixed hoặc percent coupon body |
...
- Response body/headers/assertions: Response time < 1000ms; không unexpected 5xx; cleanup created coupon.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: Basic API performance/contract assertion cho Newman.
...
| Data row key | `TC-FR17-API-SCH-007` |
