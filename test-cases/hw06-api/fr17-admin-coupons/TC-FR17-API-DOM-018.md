# TC-FR17-API-DOM-018: `min_order_amount` bằng 0 boundary hợp lệ
...
- Admin logged in; unique code `HW06MIN0{{runId}}`.
...
| Request body/query/path | `{"code":"HW06MIN0{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: FR-17 cho phép `min_order_amount >= 0`; 0 là lower boundary hợp lệ.
...
| Data row key | `TC-FR17-API-DOM-018` |
