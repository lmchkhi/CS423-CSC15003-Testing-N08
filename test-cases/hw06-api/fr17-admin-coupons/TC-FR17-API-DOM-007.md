# TC-FR17-API-DOM-007: `code` sai kiểu number
...
| Request body/query/path | `{"code":12345,"type":"percent","discount_value":10,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
| Data row key | `TC-FR17-API-DOM-007` |
