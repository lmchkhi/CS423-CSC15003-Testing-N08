# TC-FR17-API-DOM-014: `discount_value` bằng 0
...
| Request body/query/path | `{"code":"HW06DISC0{{runId}}","type":"fixed","discount_value":0,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: `discount_value` phải dương.
...
| Data row key | `TC-FR17-API-DOM-014` |
