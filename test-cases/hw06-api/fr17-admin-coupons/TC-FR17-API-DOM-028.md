# TC-FR17-API-DOM-028: `expired_at` là null
...
| Request body/query/path | `{"code":"HW06DATENULL{{runId}}","type":"percent","discount_value":10,"min_order_amount":0,"expired_at":null,"max_uses_per_user":1}` |
...
- Rationale: Null partition cho required date field.
...
| Data row key | `TC-FR17-API-DOM-028` |
...
| Human reasoning | Human thêm để hoàn thiện null partition cho `expired_at`. |
| Why AI missed it | AI có missing/malformed/past date nhưng bỏ sót null date. |
