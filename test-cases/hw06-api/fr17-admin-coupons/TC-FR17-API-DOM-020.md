# TC-FR17-API-DOM-020: `min_order_amount` sai kiểu string
...
| Request body/query/path | `{"code":"HW06MINSTR{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":"200000","expired_at":"2099-12-31","max_uses_per_user":1}` |
...
- Rationale: Numeric field cần validate type.
...
| Data row key | `TC-FR17-API-DOM-020` |
