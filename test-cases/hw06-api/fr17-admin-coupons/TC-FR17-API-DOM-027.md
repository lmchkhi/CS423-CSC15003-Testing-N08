# TC-FR17-API-DOM-027: `max_uses_per_user` sai kiểu string
...
| Request body/query/path | `{"code":"HW06MAXSTR{{runId}}","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-12-31","max_uses_per_user":"1"}` |
...
| Data row key | `TC-FR17-API-DOM-027` |
