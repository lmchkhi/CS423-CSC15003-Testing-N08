# TC-FR17-API-SEC-002: Authorization header malformed: Bearer không có token
...
- Rationale: Malformed token không phải valid JWT.
...
| Data row key | `TC-FR17-API-SEC-002` |
