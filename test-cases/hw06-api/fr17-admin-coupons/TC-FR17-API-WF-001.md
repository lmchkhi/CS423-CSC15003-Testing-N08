# TC-FR17-API-WF-001: Create coupon rồi verify xuất hiện trong coupon list
...
| Request body/query/path | `POST /api/admin/coupons` valid body, sau đó `GET /api/coupons` |
...
- HTTP status: `200/201 then 200`.
- Response body/headers/assertions: List contains created code với các field chính khớp; cleanup bằng DELETE.
- Không có unexpected `5xx` nếu đây là negative/security case.
- Rationale: FR-17 gồm Add và View coupon behavior.
...
| Data row key | `TC-FR17-API-WF-001` |
