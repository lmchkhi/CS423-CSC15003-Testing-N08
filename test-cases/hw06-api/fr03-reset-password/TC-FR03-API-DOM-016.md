# TC-FR03-API-DOM-016: `newPassword` là null
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}","newPassword":null}` |
...
| Data row key | `TC-FR03-API-DOM-016` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Null password invalid. |
