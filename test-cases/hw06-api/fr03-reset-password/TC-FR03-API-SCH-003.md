# TC-FR03-API-SCH-003: Error response cho missing email có message/error
...
| Authorization | `none` |
| Request body/query/path | `{"resetToken":"123456","newPassword":"NewPass123!"}` |
...
- HTTP status: `400`.
- Response body/headers/assertions: Body có `message` hoặc `error` dạng string..
...
| Data row key | `TC-FR03-API-SCH-003` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Negative schema. |
