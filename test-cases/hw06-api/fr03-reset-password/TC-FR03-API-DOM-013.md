# TC-FR03-API-DOM-013: `resetToken` dài 7 digits
...
- Có setup forgot-password trước đó.
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"1234567","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-013` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Boundary trên OTP 6 digits. |
