# TC-FR03-API-DOM-009: Thiếu field `resetToken`
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-009` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | resetToken là required field. |
