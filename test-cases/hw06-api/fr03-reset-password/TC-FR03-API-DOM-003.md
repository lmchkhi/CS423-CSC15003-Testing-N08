# TC-FR03-API-DOM-003: `email` là null
...
| Authorization | `none` |
| Request body/query/path | `{"email":null,"resetToken":"{{validResetToken}}","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-003` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Null email là invalid partition. |
