# TC-FR03-API-SCH-006: Reset success không trả lại `resetToken`
...
- HTTP status: `200`.
- Response body/headers/assertions: Response không có `resetToken`..
...
| Data row key | `TC-FR03-API-SCH-006` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Token đã dùng không nên được trả lại. |
