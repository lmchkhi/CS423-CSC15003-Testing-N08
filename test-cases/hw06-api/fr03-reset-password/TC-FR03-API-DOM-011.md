# TC-FR03-API-DOM-011: `resetToken` là empty string
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-011` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Empty token invalid. |
