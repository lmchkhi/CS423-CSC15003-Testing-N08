# TC-FR03-API-DOM-014: `resetToken` chứa chữ cái
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"12ab56","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-014` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | OTP phải chỉ gồm chữ số. |
