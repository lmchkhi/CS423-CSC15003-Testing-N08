# TC-FR03-API-SCH-008: GET /api/reset-password không được thành công
...
| Authorization | `none` |
| Request body/query/path | `GET /api/reset-password` |
...
- Response body/headers/assertions: Không trả success schema của POST reset-password..
...
| Data row key | `TC-FR03-API-SCH-008` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Method contract: spec chỉ định POST. |
