# TC-FR03-API-DOM-010: `resetToken` là null
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":null,"newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-010` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Null token invalid. |
