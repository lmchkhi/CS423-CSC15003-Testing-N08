# TC-FR03-API-DOM-023: `newPassword` là empty string
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}","newPassword":""}` |
...
| Data row key | `TC-FR03-API-DOM-023` |
...
| Human reasoning | Human thêm vì AI có missing/null/too short nhưng bỏ sót empty string riêng cho password. |
| Why AI missed it | AI thường gộp empty password với too-short password nên bỏ sót partition rỗng. |
