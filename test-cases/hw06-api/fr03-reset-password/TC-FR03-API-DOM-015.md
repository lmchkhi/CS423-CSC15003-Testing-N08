# TC-FR03-API-DOM-015: Thiếu field `newPassword`
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}"}` |
...
| Data row key | `TC-FR03-API-DOM-015` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | newPassword là required field. |
