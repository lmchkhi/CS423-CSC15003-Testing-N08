# TC-FR03-API-SEC-007: Reset success response không trả password/password hash
...
- HTTP status: `200`.
- Response body/headers/assertions: Response không có `password`, `password_hash`, `newPassword`..
...
| Data row key | `TC-FR03-API-SEC-007` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Sensitive data exposure check. |
