# TC-FR03-API-DOM-017: `newPassword` quá ngắn
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}","newPassword":"Aa1!"}` |
...
| Data row key | `TC-FR03-API-DOM-017` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Password phải tối thiểu 8 ký tự. |
