# TC-FR03-API-SEC-002: SQL injection payload trong `resetToken` không gây 500/leak
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"'; SELECT 1; --","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-SEC-002` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | SEC-05 trên token field. |
