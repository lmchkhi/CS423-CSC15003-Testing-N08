# TC-FR03-API-DOM-025: `resetToken` 6 digits nhưng có whitespace đầu/cuối
...
| Data row key | `TC-FR03-API-DOM-025` |
...
| Human reasoning | Human thêm whitespace boundary cho token. |
| Why AI missed it | AI kiểm tra whitespace email nhưng bỏ sót whitespace token. |
