# TC-FR03-API-DOM-022: `newPassword` là number
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}","newPassword":12345678}` |
...
| Data row key | `TC-FR03-API-DOM-022` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Wrong type cho password. |
