# TC-FR03-API-WF-006: Failed reset do weak password không consume valid token
...
| Authorization | `none` |
| Request body/query/path | `1) reset với weak password; 2) reset lại cùng token với strong password` |
...
- Response body/headers/assertions: Lần 1 có error; lần 2 có `message` success..
...
| Data row key | `TC-FR03-API-WF-006` |
...
| Human reasoning | Bổ sung sequence rõ ràng cho token consumption. |
