# TC-FR03-API-SCH-007: Reset response không trả `newPassword` hoặc password plaintext
...
- HTTP status: `200`.
- Response body/headers/assertions: Response không có `newPassword`, `password`, `password_hash`..
...
| Data row key | `TC-FR03-API-SCH-007` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Sensitive schema assertion. |
