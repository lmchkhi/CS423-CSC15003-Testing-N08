# TC-FR03-API-SCH-004: Invalid token error không expose stack trace
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"000000","newPassword":"NewPass123!"}` |
...
- HTTP status: `400`.
- Response body/headers/assertions: Không có `stack`, `trace`, `sql`, `exception`..
...
| Data row key | `TC-FR03-API-SCH-004` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Security/schema negative response. |
