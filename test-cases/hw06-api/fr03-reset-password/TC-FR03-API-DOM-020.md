# TC-FR03-API-DOM-020: `newPassword` thiếu digit
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"{{validResetToken}}","newPassword":"NewPassword!"}` |
...
| Data row key | `TC-FR03-API-DOM-020` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Password phải có digit. |
