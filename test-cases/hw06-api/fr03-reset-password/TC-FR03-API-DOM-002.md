# TC-FR03-API-DOM-002: Thiếu field `email`
...
| Authorization | `none` |
| Request body/query/path | `{"resetToken":"{{validResetToken}}","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-002` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | email là required field theo API spec. |
