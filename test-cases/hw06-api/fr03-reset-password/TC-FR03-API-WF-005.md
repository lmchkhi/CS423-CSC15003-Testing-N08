# TC-FR03-API-WF-005: Sau reset thành công, new password login được
...
| Authorization | `none` |
| Request body/query/path | `POST /api/login với new password` |
...
- HTTP status: `200`.
- Response body/headers/assertions: Response có `token` và `user`..
...
| Data row key | `TC-FR03-API-WF-005` |
