# TC-FR03-API-SCH-002: Success response có `message` dạng string
...
- HTTP status: `200`.
- Response body/headers/assertions: Body có `message:string`; chỉ chứa field public expected..
...
| Data row key | `TC-FR03-API-SCH-002` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Success schema. |
