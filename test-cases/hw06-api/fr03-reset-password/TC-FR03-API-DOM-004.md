# TC-FR03-API-DOM-004: `email` là empty string
...
| Authorization | `none` |
| Request body/query/path | `{"email":"","resetToken":"{{validResetToken}}","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-004` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Empty email là invalid partition. |
