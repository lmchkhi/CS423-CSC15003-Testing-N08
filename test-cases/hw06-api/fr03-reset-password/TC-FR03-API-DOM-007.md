# TC-FR03-API-DOM-007: `email` là number
...
| Authorization | `none` |
| Request body/query/path | `{"email":12345,"resetToken":"{{validResetToken}}","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-007` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | Wrong type cho email. |
