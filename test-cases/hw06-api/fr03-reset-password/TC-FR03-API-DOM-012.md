# TC-FR03-API-DOM-012: `resetToken` chỉ 5 digits
...
| Authorization | `none` |
| Request body/query/path | `{"email":"test@eshop.com","resetToken":"12345","newPassword":"NewPass123!"}` |
...
| Data row key | `TC-FR03-API-DOM-012` |
...
| Source | `AI` |
| Audit label | `VALID` |
| Human reasoning | OTP phải là 6 digits. |
