...
- Name: fr03-forgot-reset-password.spec.ts >> FR03-TC-007 registered email receives a visible random 6-digit OTP
...
Received string:  "
    EShopGiỏ hàngĐăng nhậpĐăng kýQuên Mật KhẩuMã OTP của bạn là: 9816Mã OTP (4 số)Mật khẩu mớiĐặt lại mật khẩu← Quay lại© 2026 EShop SUT. Dành cho mục đích kiểm thử.·········
"

Call log:
  - Expect "toContainText" with timeout 1500ms
...
- main:
  ...
  - text: "Mã OTP của bạn là: 9816 Mã OTP (4 số)"
  - textbox
  - text: Mật khẩu mới
  - textbox
