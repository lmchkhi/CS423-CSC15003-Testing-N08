...
- Name: fr03-forgot-reset-password.spec.ts >> FR03-TC-012 mismatched new password confirmation is rejected
- Location: tests/fr03-forgot-reset-password.spec.ts:259:3

# Error details

```
Error: FR-03 requires a confirm-new-password field
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 8946"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "8946"
        - generic [ref=e18]:
          - generic [ref=e19]: Mật khẩu mới
          - textbox [active] [ref=e20]: NewPass123!
