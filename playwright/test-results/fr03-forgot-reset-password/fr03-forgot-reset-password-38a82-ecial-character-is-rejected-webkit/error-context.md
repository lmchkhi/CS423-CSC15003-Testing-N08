...
- Name: fr03-forgot-reset-password.spec.ts >> FR03-TC-011 new password without a special character is rejected
- Location: tests/fr03-forgot-reset-password.spec.ts:259:3

# Error details

```
Error: reset form should still provide password confirmation
...
- generic [ref=e3]:
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      ...
      - generic [ref=e13]:
        - generic [ref=e14]: "Mã OTP của bạn là: 2637"
        - generic [ref=e15]:
          - generic [ref=e16]: Mã OTP (4 số)
          - textbox [ref=e17]: "2637"
        - generic [ref=e18]:
          - generic [ref=e19]: Mật khẩu mới
          - textbox [ref=e20]: NoSpecial123
