...
- Name: fr03-forgot-reset-password.spec.ts >> FR03-TC-008 after OTP request Step 2 shows a visible two-step indicator
...
Timeout: 7000ms
Expected pattern: /Bước\s*2\s*\/\s*2|Step\s*2\s*\/\s*2/
Received string:  "
    EShopGiỏ hàngĐăng nhậpĐăng kýQuên Mật KhẩuMã OTP của bạn là: 2747Mã OTP (4 số)Mật khẩu mớiĐặt lại mật khẩu← Quay lại© 2026 EShop SUT. Dành cho mục đích kiểm thử.·········
"
...
- main:
  ...
  - text: "Mã OTP của bạn là: 2747 Mã OTP (4 số)"
  - textbox
  - text: Mật khẩu mới
  - textbox
